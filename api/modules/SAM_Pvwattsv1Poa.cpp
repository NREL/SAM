...
SAM_EXPORT void
SAM_Pvwattsv1Poa_Weather_poa_gnddiff_aset(SAM_Pvwattsv1Poa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Pvwattsv1Poa_Weather_poa_skydiff_aset(SAM_Pvwattsv1Poa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
