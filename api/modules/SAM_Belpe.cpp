...
SAM_EXPORT void
SAM_Belpe_LoadProfileEstimator_Monthly_util_aset(SAM_Belpe ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Belpe_LoadProfileEstimator_Occ_Schedule_aset(SAM_Belpe ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Belpe_LoadProfileEstimator_solar_resource_file_sset(SAM_Belpe ptr, const char *str, SAM_error *err) {
    translateExceptions(err, [&] {
