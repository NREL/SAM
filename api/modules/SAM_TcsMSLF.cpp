...
SAM_EXPORT void
SAM_TcsMSLF_TouTranslator_weekday_schedule_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_TouTranslator_weekend_schedule_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_OpticalTable_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_epsilon_abs_1_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_epsilon_abs_2_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_epsilon_abs_3_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_epsilon_abs_4_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_field_fl_props_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_k_tes_loss_coeffs_aset(SAM_TcsMSLF ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_Controller_store_fl_props_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsMSLF_UserDefinedPC_ud_ind_od_mset(SAM_TcsMSLF ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsMSLF_TouTranslator_weekday_schedule_mget(SAM_TcsMSLF ptr, int *nrows, int *ncols, SAM_error *err) {
...
SAM_EXPORT double *
SAM_TcsMSLF_TouTranslator_weekend_schedule_mget(SAM_TcsMSLF ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
