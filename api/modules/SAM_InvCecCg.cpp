...
SAM_EXPORT void
SAM_InvCecCg_Common_inv_cec_cg_sample_power_units_nset(SAM_InvCecCg ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_InvCecCg_Common_inv_cec_cg_test_samples_mset(SAM_InvCecCg ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_InvCecCg_Common_inv_cec_cg_test_samples_mget(SAM_InvCecCg ptr, int *nrows, int *ncols, SAM_error *err) {
