...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_dispatch_manual_fuelcellcharge_aset(SAM_Fuelcell ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_array(ptr, "dispatch_manual_fuelcellcharge", arr, length);
    });
}

SAM_EXPORT void SAM_Fuelcell_FuelCell_dispatch_manual_fuelcelldischarge_aset(SAM_Fuelcell ptr, double *arr, int length,
                                                                             SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_dispatch_manual_percent_fc_discharge_aset(SAM_Fuelcell ptr, double *arr, int length,
                                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_dispatch_manual_sched_mset(SAM_Fuelcell ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_dispatch_manual_sched_weekend_mset(SAM_Fuelcell ptr, double *mat, int nrows, int ncols,
                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Fuelcell_FuelCell_dispatch_manual_units_fc_discharge_aset(SAM_Fuelcell ptr, double *arr, int length,
                                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_availability_schedule_mset(SAM_Fuelcell ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_degradation_restart_nset(SAM_Fuelcell ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_degradation_restart_schedule_nset(SAM_Fuelcell ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_degradation_restarts_per_year_nset(SAM_Fuelcell ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_dispatch_aset(SAM_Fuelcell ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_dynamic_response_down_nset(SAM_Fuelcell ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_dynamic_response_up_nset(SAM_Fuelcell ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_efficiency_mset(SAM_Fuelcell ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_replacement_option_nset(SAM_Fuelcell ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_replacement_percent_nset(SAM_Fuelcell ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Fuelcell_FuelCell_fuelcell_replacement_schedule_aset(SAM_Fuelcell ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_dispatch_manual_fuelcellcharge_aget(SAM_Fuelcell ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_dispatch_manual_fuelcelldischarge_aget(SAM_Fuelcell ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_dispatch_manual_percent_fc_discharge_aget(SAM_Fuelcell ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_dispatch_manual_sched_mget(SAM_Fuelcell ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_dispatch_manual_sched_weekend_mget(SAM_Fuelcell ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_dispatch_manual_units_fc_discharge_aget(SAM_Fuelcell ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_fuelcell_availability_schedule_mget(SAM_Fuelcell ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_fuelcell_efficiency_mget(SAM_Fuelcell ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_FuelCell_fuelcell_replacement_schedule_aget(SAM_Fuelcell ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_Outputs_fuelcell_electrical_efficiency_aget(SAM_Fuelcell ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Fuelcell_Outputs_fuelcell_fuel_consumption_mcf_aget(SAM_Fuelcell ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
