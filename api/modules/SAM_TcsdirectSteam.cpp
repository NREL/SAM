...
SAM_EXPORT void
SAM_TcsdirectSteam_Heliostat_check_max_flux_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_TcsdirectSteam_Heliostat_csp_pt_sf_land_overhead_factor_nset(SAM_TcsdirectSteam ptr, double number,
                                                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_Heliostat_delta_flux_hrs_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_Heliostat_land_spec_cost_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_Heliostat_sales_tax_frac_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_Heliostat_sales_tax_rate_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_Heliostat_site_spec_cost_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_DsgController_T_approach_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_DsgController_d_t_boiler_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_DsgController_mat_boiler_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_DsgController_x_b_target_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsdirectSteam_Parasitics_Piping_length_nset(SAM_TcsdirectSteam ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
