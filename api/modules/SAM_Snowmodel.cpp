...
SAM_EXPORT void
SAM_Snowmodel_PVSnowModel_subarray1_poa_shaded_aset(SAM_Snowmodel ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Snowmodel_PVSnowModel_subarray1_surf_tilt_aset(SAM_Snowmodel ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Snowmodel_Outputs_hourly_energy_before_snow_aget(SAM_Snowmodel ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Snowmodel_Outputs_monthly_energy_before_snow_aget(SAM_Snowmodel ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
