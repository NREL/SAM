...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_avoided_cred_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_collection_fuel_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_grid_intensity_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_pre_grindopt_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_pre_pelletopt_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_transport_fuel_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_transport_legs_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_transport_long_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_transport_longmiles_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_transport_longopt_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_emissions_transport_predist_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_additional_opt_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_bagasse_frac_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_bagasse_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_barley_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_bit_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_collection_radius_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock1_c_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock1_frac_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock1_h_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock1_hhv_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock1_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock1_resource_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock2_c_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock2_frac_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock2_h_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock2_hhv_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock2_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_feedstock2_resource_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_forest_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_herb_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_lig_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_mill_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_rice_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_stover_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_subbit_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_total_biomass_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_total_biomass_c_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_total_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_urban_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_wheat_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_feedstock_woody_moisture_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_plant_boiler_cap_per_boiler_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_plant_boiler_flue_temp_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_plant_boiler_over_design_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_plant_boiler_steam_enthalpy_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_plant_boiler_steam_pressure_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_plant_cycle_design_temp_nset(SAM_Biomass ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Biomass_Biopower_biopwr_plant_disp_power_aset(SAM_Biomass ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
