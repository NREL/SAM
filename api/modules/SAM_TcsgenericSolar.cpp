...
SAM_EXPORT SAM_TcsgenericSolar SAM_TcsgenericSolar_construct(const char *def, SAM_error *err) {
    SAM_TcsgenericSolar result = nullptr;
...
SAM_EXPORT void
SAM_TcsgenericSolar_GenericSolar_system_capacity_nset(SAM_TcsgenericSolar ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_TouTranslator_weekday_schedule_mset(SAM_TcsgenericSolar ptr, double *mat, int nrows, int ncols,
                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_TouTranslator_weekend_schedule_mset(SAM_TcsgenericSolar ptr, double *mat, int nrows, int ncols,
                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_OpticalTable_mset(SAM_TcsgenericSolar ptr, double *mat, int nrows, int ncols,
                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_Wpar_prodD_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_Wpar_prodQ_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_Wpar_prodT_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_diswos_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_disws_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_etaQ_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_etaT_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_exergy_table_mset(SAM_TcsgenericSolar ptr, double *mat, int nrows, int ncols,
                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_fdisp_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_istableunsorted_nset(SAM_TcsgenericSolar ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_qdisp_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_sfhlQ_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_sfhlT_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_sfhlV_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_storage_config_nset(SAM_TcsgenericSolar ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_teshlT_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcsgenericSolar_Type260_teshlX_coefs_aset(SAM_TcsgenericSolar ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_TouTranslator_weekday_schedule_mget(SAM_TcsgenericSolar ptr, int *nrows, int *ncols,
                                                        SAM_error *err) {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_TouTranslator_weekend_schedule_mget(SAM_TcsgenericSolar ptr, int *nrows, int *ncols,
                                                        SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Type260_OpticalTable_mget(SAM_TcsgenericSolar ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Type260_Wpar_prodD_coefs_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Type260_Wpar_prodQ_coefs_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Type260_Wpar_prodT_coefs_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Type260_exergy_table_mget(SAM_TcsgenericSolar ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_energy_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_dump_tot_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_fossil_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_from_tes_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_hl_sf_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_hl_tes_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_startup_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_to_pb_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_monthly_q_to_tes_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_q_dump_teschg_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_q_dump_tesfull_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcsgenericSolar_Outputs_w_par_offline_aget(SAM_TcsgenericSolar ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
