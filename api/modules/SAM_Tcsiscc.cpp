...
SAM_EXPORT int SAM_Tcsiscc_execute(SAM_Tcsiscc data, int verbosity, SAM_error *err) {
    int n_err = 0;
    translateExceptions(err, [&] {
        n_err += SAM_module_exec("tcsiscc", data, verbosity, err);
    });
    return n_err;
}
...
SAM_EXPORT double *
SAM_Tcsiscc_Heliostat_helio_aim_points_mget(SAM_Tcsiscc ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Tcsiscc_Heliostat_land_bound_table_mget(SAM_Tcsiscc ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
