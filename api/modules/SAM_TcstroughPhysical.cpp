...
SAM_EXPORT void
SAM_TcstroughPhysical_Weather_file_name_sset(SAM_TcstroughPhysical ptr, const char *str, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Weather_track_mode_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Trough_system_capacity_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_A_aperture_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_AbsorberMaterial_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_AnnulusGas_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Ave_Focal_Length_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_ColperSCA_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_array(ptr, "ColperSCA", arr, length);
    });
}

SAM_EXPORT void SAM_TcstroughPhysical_SolarField_D_2_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_TcstroughPhysical_SolarField_D_3_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_TcstroughPhysical_SolarField_D_4_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_TcstroughPhysical_SolarField_D_5_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_D_cpnt_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                             SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_TcstroughPhysical_SolarField_D_p_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Design_loss_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Dirt_HCE_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                               SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Dirt_mirror_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Distance_SCA_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_EPSILON_4_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_EPSILON_5_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Error_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_FieldConfig_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Flow_type_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_GeomEffects_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_GlazingIntactIn_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                      SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_HCE_FieldFrac_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_HDR_rough_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_IAM_matrix_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_I_bn_des_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_K_cpnt_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                             SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_L_SCA_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_L_aperture_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_L_cpnt_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                             SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_L_rnr_pb_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_L_rnr_per_xpan_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_L_xpan_hdr_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_L_xpan_rnr_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Min_rnr_xpans_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_N_hdr_per_xpan_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_N_max_hdr_diams_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "N_max_hdr_diams", number);
    });
}

SAM_EXPORT void SAM_TcstroughPhysical_SolarField_P_a_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Pipe_hl_coef_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Rho_mirror_clean_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Rough_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                            SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Row_Distance_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_SCADefocusArray_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                      SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_SCAInfoArray_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_SCA_drives_elec_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Shadowing_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_T_loop_in_des_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_T_loop_out_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_T_startup_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Tau_envelope_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_TcstroughPhysical_SolarField_TrackingError_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_Type_cpnt_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_V_hdr_cold_max_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_V_hdr_cold_min_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_V_hdr_hot_max_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_V_hdr_hot_min_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_W_aperture_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_accept_init_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_accept_loc_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_accept_mode_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_alpha_abs_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_alpha_env_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_calc_design_pipe_vals_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_custom_sf_pipe_sizes_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_11_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_12_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_13_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_14_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_21_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_22_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_23_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_24_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_31_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_32_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_33_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_34_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_41_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_42_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_43_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_epsilon_3_44_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_eta_pump_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_fthrctrl_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_m_dot_htfmax_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_m_dot_htfmin_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_mc_bal_cold_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_mc_bal_hot_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_mc_bal_sca_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_nHCEVar_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_northsouth_field_sep_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_offset_xpan_hdr_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_sf_hdr_diams_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_array(ptr, "sf_hdr_diams", arr, length);
    });
}

SAM_EXPORT void SAM_TcstroughPhysical_SolarField_sf_hdr_lengths_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_sf_hdr_wallthicks_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_sf_rnr_diams_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_array(ptr, "sf_rnr_diams", arr, length);
    });
}

SAM_EXPORT void SAM_TcstroughPhysical_SolarField_sf_rnr_lengths_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_sf_rnr_wallthicks_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_solar_mult_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_theta_dep_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_theta_stow_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_washing_frequency_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_water_usage_per_wash_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_HDR_rough_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "HDR_rough", number);
    });
}
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_T_set_aux_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_T_tank_cold_ini_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_T_tank_hot_inlet_min_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_V_tank_hot_ini_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_V_tes_des_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_W_pb_design_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_aux_array_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_bop_array_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_cold_tank_Thtr_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_custom_sgs_pipe_sizes_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_custom_tes_p_loss_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_cycle_cutoff_frac_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_cycle_max_frac_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_dt_cold_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_eta_pump_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "eta_pump", number);
    });
}
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_f_tc_cold_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_ffrac_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_field_fl_props_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_fossil_mode_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_h_tank_min_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_has_hot_tank_bypass_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_hot_tank_Thtr_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_hx_config_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_k_tes_loss_coeffs_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_pb_fixed_par_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_pb_pump_coef_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_q_max_aux_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_q_pb_design_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_sf_type_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_sgs_diams_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_sgs_lengths_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_array(ptr, "sgs_lengths", arr, length);
    });
}

SAM_EXPORT void SAM_TcstroughPhysical_Controller_sgs_wallthicks_aset(SAM_TcstroughPhysical ptr, double *arr, int length,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_store_fl_props_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_store_fluid_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_t_ch_out_max_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_t_dis_out_min_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_t_standby_reset_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tank_max_heat_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tank_pairs_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tanks_in_parallel_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tc_fill_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tc_void_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tes_pump_coef_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tes_type_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tshours_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tslogic_a_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tslogic_b_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_tslogic_c_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Controller_vol_tank_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_TouTranslator_weekday_schedule_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_TouTranslator_weekend_schedule_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_F_wc_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_P_cond_min_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_P_cond_ratio_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_T_ITD_des_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_T_amb_des_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_T_approach_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_dT_cw_ref_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_eta_ref_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_n_pl_inc_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_pb_bd_frac_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_pc_config_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_q_sby_frac_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_startup_frac_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_startup_time_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_Powerblock_tech_type_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_T_amb_des_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_T_amb_high_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_T_amb_ind_od_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_T_amb_low_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_T_htf_high_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_T_htf_ind_od_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_T_htf_low_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_f_W_dot_cool_des_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_ind_od_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols,
                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_m_dot_htf_high_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_m_dot_htf_ind_od_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows,
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_m_dot_htf_low_nset(SAM_TcstroughPhysical ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_TcstroughPhysical_UserDefinedPC_ud_m_dot_water_cool_des_nset(SAM_TcstroughPhysical ptr, double number,
                                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_A_aperture_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_AbsorberMaterial_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                       SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_AnnulusGas_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Ave_Focal_Length_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_ColperSCA_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_D_2_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_D_3_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_D_4_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_D_5_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_D_cpnt_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_D_p_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Design_loss_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Dirt_HCE_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Dirt_mirror_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Distance_SCA_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_EPSILON_4_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_EPSILON_5_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Flow_type_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_GeomEffects_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_GlazingIntactIn_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                      SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_HCE_FieldFrac_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_IAM_matrix_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_K_cpnt_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_L_aperture_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_L_cpnt_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_P_a_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Rho_mirror_clean_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Rough_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_SCADefocusArray_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_SCAInfoArray_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Shadowing_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Tau_envelope_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_TrackingError_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_Type_cpnt_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_W_aperture_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_alpha_abs_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_alpha_env_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_SolarField_calc_design_pipe_vals_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_SolarField_custom_sf_pipe_sizes_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_11_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_12_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_13_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_14_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_21_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_22_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_23_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_24_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_31_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_32_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_33_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_34_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_41_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_42_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_43_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_epsilon_3_44_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_SolarField_northsouth_field_sep_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_sf_hdr_diams_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_sf_hdr_lengths_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_sf_hdr_wallthicks_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_sf_rnr_diams_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_sf_rnr_lengths_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_SolarField_sf_rnr_wallthicks_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_SolarField_water_usage_per_wash_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_Controller_T_tank_hot_inlet_min_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_aux_array_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_bop_array_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_Controller_custom_sgs_pipe_sizes_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_field_fl_props_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                     SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_k_tes_loss_coeffs_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_sgs_diams_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_sgs_lengths_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_sgs_wallthicks_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_store_fl_props_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                     SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_tslogic_a_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_tslogic_b_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_tslogic_c_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_TouTranslator_weekday_schedule_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                          SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_TouTranslator_weekend_schedule_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                          SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_UserDefinedPC_ud_T_amb_ind_od_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_UserDefinedPC_ud_T_htf_ind_od_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_UserDefinedPC_ud_f_W_dot_cool_des_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_UserDefinedPC_ud_ind_od_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_UserDefinedPC_ud_m_dot_htf_high_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_UserDefinedPC_ud_m_dot_htf_ind_od_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols,
                                                             SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_TcstroughPhysical_UserDefinedPC_ud_m_dot_water_cool_des_nget(SAM_TcstroughPhysical ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_CosTh_ave_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_E_bal_startup_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_EndLoss_ave_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_Fuel_usage_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_Q_aux_backup_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_Q_par_sf_fp_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_Q_par_tes_fp_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_RowShadow_ave_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_SCA_par_tot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_T_field_in_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_T_tank_cold_fin_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_T_tank_cold_in_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_T_tank_hot_fin_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_T_tank_hot_in_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_Theta_ave_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_W_cool_par_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_W_cycle_gross_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_W_dot_pump_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_dni_costh_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_fixed_par_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_htf_pump_power_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_m_dot_aux_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_m_dot_avail_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_m_dot_charge_field_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_m_dot_discharge_tank_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_m_dot_htf2_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_m_dot_makeup_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_mass_tank_cold_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_mass_tank_hot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_Fuel_usage_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_W_cycle_gross_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_energy_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_m_dot_makeup_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_q_abs_tot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_q_avail_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_q_dump_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_q_inc_sf_tot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_q_pb_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_monthly_q_to_tes_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_P_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_T_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_diams_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_expansions_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_lengths_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_mdot_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_vel_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_header_wallthk_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_loop_P_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_loop_T_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_P_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_T_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_diams_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_expansions_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_lengths_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_mdot_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_vel_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_runner_wallthk_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_sgs_P_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_sgs_T_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_sgs_diams_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_sgs_mdot_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_sgs_vel_dsn_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_pipe_sgs_wallthk_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_q_abs_tot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_q_inc_sf_tot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_q_loss_spec_tot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_q_loss_tot_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_qinc_costh_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_recirculating_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_tank_losses_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_tou_value_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_vol_tank_cold_fin_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_vol_tank_hot_fin_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Outputs_vol_tank_total_aget(SAM_TcstroughPhysical ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
