...
SAM_EXPORT SAM_Thirdpartyownership SAM_Thirdpartyownership_construct(const char *def, SAM_error *err) {
    SAM_Thirdpartyownership result = nullptr;
...
SAM_EXPORT int SAM_Thirdpartyownership_execute(SAM_Thirdpartyownership data, int verbosity, SAM_error *err) {
    int n_err = 0;
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Thirdpartyownership_destruct(SAM_Thirdpartyownership system) {
    ssc_data_free(system);
}

SAM_EXPORT void
SAM_Thirdpartyownership_Depreciation_depr_fed_custom_aset(SAM_Thirdpartyownership ptr, double *arr, int length,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Thirdpartyownership_Depreciation_depr_fed_sl_years_nset(SAM_Thirdpartyownership ptr, double number,
                                                                            SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Depreciation_depr_fed_type_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Depreciation_depr_sta_custom_aset(SAM_Thirdpartyownership ptr, double *arr, int length,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Thirdpartyownership_Depreciation_depr_sta_sl_years_nset(SAM_Thirdpartyownership ptr, double number,
                                                                            SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Depreciation_depr_sta_type_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Financials_analysis_period_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Financials_inflation_rate_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Financials_real_discount_rate_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_FinancialThirdPartyOwnership_lease_or_ppa_nset(SAM_Thirdpartyownership ptr, double number,
                                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Common_annual_energy_value_aset(SAM_Thirdpartyownership ptr, double *arr, int length,
                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_Common_gen_aset(SAM_Thirdpartyownership ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_AnnualOutput_degradation_aset(SAM_Thirdpartyownership ptr, double *arr, int length,
                                                      SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_AnnualOutput_system_use_lifetime_output_nset(SAM_Thirdpartyownership ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_CashFlow_lease_escalation_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_CashFlow_lease_price_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_CashFlow_ppa_escalation_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_CashFlow_ppa_price_nset(SAM_Thirdpartyownership ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_ElectricityCost_elec_cost_with_system_aset(SAM_Thirdpartyownership ptr, double *arr, int length,
                                                                   SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Thirdpartyownership_ElectricityCost_elec_cost_without_system_aset(SAM_Thirdpartyownership ptr, double *arr,
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Depreciation_depr_fed_custom_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
...
SAM_EXPORT double
SAM_Thirdpartyownership_Depreciation_depr_fed_sl_years_nget(SAM_Thirdpartyownership ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Depreciation_depr_sta_custom_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Thirdpartyownership_Depreciation_depr_sta_sl_years_nget(SAM_Thirdpartyownership ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Thirdpartyownership_Financials_real_discount_rate_nget(SAM_Thirdpartyownership ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Thirdpartyownership_FinancialThirdPartyOwnership_lease_or_ppa_nget(SAM_Thirdpartyownership ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Common_annual_energy_value_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_AnnualOutput_degradation_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Thirdpartyownership_AnnualOutput_system_use_lifetime_output_nget(SAM_Thirdpartyownership ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_ElectricityCost_elec_cost_with_system_aget(SAM_Thirdpartyownership ptr, int *length,
                                                                   SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_ElectricityCost_elec_cost_without_system_aget(SAM_Thirdpartyownership ptr, int *length,
                                                                      SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Outputs_cf_after_tax_cash_flow_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Outputs_cf_after_tax_net_equity_cost_flow_aget(SAM_Thirdpartyownership ptr, int *length,
                                                                       SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Outputs_cf_agreement_cost_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Outputs_cf_cumulative_payback_with_expenses_aget(SAM_Thirdpartyownership ptr, int *length,
                                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Outputs_cf_energy_net_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Outputs_cf_nte_aget(SAM_Thirdpartyownership ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Thirdpartyownership_Outputs_cf_payback_with_expenses_aget(SAM_Thirdpartyownership ptr, int *length,
                                                              SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
