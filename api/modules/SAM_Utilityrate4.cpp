...
SAM_EXPORT void
SAM_Utilityrate4_Common_load_escalation_aset(SAM_Utilityrate4 ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_rate_escalation_aset(SAM_Utilityrate4 ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_system_use_lifetime_output_nset(SAM_Utilityrate4 ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_dc_flat_mat_mset(SAM_Utilityrate4 ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_dc_sched_weekday_mset(SAM_Utilityrate4 ptr, double *mat, int nrows, int ncols,
                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_dc_sched_weekend_mset(SAM_Utilityrate4 ptr, double *mat, int nrows, int ncols,
                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_dc_tou_mat_mset(SAM_Utilityrate4 ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_ec_sched_weekday_mset(SAM_Utilityrate4 ptr, double *mat, int nrows, int ncols,
                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_ec_sched_weekend_mset(SAM_Utilityrate4 ptr, double *mat, int nrows, int ncols,
                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_ec_tou_mat_mset(SAM_Utilityrate4 ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_monthly_fixed_charge_nset(SAM_Utilityrate4 ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_monthly_min_charge_nset(SAM_Utilityrate4 ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_Common_ur_nm_yearend_sell_rate_nset(SAM_Utilityrate4 ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate4_AnnualOutput_degradation_aset(SAM_Utilityrate4 ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Common_ur_dc_flat_mat_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Common_ur_dc_sched_weekday_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Common_ur_dc_sched_weekend_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Common_ur_dc_tou_mat_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Common_ur_ec_sched_weekday_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Common_ur_ec_sched_weekend_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Common_ur_ec_tou_mat_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_annual_electric_load_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_annual_energy_value_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_dc_fixed_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_dc_fixed_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_dc_tou_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_dc_tou_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_apr_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_aug_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_dec_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_feb_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_jan_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_jul_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_jun_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_mar_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_may_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_nov_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_oct_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_sep_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_ec_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_fixed_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_minimum_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_w_sys_minimum_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_dc_fixed_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_dc_fixed_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_dc_tou_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_dc_tou_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_apr_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_aug_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_dec_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_feb_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_jan_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_jul_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_jun_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_mar_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_may_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_nov_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_oct_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_sep_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_ec_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_fixed_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_fixed_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_minimum_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_charge_wo_sys_minimum_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_elec_cost_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_elec_cost_without_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_apr_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_aug_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_dec_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_feb_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_jan_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_jul_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_jun_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_mar_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_may_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_nov_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_oct_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_w_sys_ec_sep_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_apr_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_aug_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_dec_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_feb_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_jan_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_jul_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_jun_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_mar_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_may_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_nov_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_oct_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_energy_wo_sys_ec_sep_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_apr_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_aug_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_dec_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_feb_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_jan_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_jul_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_jun_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_mar_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_may_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_nov_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_oct_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_surplus_w_sys_ec_sep_tp_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_utility_bill_w_sys_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_utility_bill_wo_sys_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_utility_bill_wo_sys_ym_mget(SAM_Utilityrate4 ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_dc_peak_per_period_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_dc_tou_schedule_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_dc_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_dc_without_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_e_fromgrid_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_e_tofromgrid_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_e_togrid_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_ec_tou_schedule_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_ec_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_ec_without_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_p_system_to_load_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_p_tofromgrid_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_salespurchases_with_system_aget(SAM_Utilityrate4 ptr, int *length,
                                                                      SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_salespurchases_without_system_aget(SAM_Utilityrate4 ptr, int *length,
                                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_hourly_system_to_load_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_cumulative_excess_dollars_aget(SAM_Utilityrate4 ptr, int *length,
                                                                      SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_cumulative_excess_generation_aget(SAM_Utilityrate4 ptr, int *length,
                                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_dc_fixed_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_dc_fixed_without_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_dc_tou_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_dc_tou_without_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_ec_charge_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_ec_charge_without_system_aget(SAM_Utilityrate4 ptr, int *length,
                                                                     SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_electricity_to_grid_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_fixed_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_fixed_without_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_minimum_with_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_minimum_without_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_peak_w_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_peak_wo_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_use_w_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_use_wo_system_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_utility_bill_w_sys_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate4_Outputs_year1_monthly_utility_bill_wo_sys_aget(SAM_Utilityrate4 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
