...
SAM_EXPORT void SAM_Equpartflip_FinancialParameters_federal_tax_rate_aset(SAM_Equpartflip ptr, double *arr, int length,
                                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_SystemCosts_om_fixed_aset(SAM_Equpartflip ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_SystemCosts_om_fuel_cost_escal_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_deprbas_fed_nset(SAM_Equpartflip ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_deprbas_sta_nset(SAM_Equpartflip ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_deprbas_fed_nset(SAM_Equpartflip ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_deprbas_sta_nset(SAM_Equpartflip ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_Depreciation_depr_itc_fed_sl_5_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_Depreciation_depr_itc_sta_sl_5_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_PaymentIncentives_pbi_fed_term_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_PaymentIncentives_pbi_oth_term_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_PaymentIncentives_pbi_sta_term_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_PaymentIncentives_pbi_uti_term_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Equpartflip_IRRTargets_flip_target_percent_nset(SAM_Equpartflip ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Equpartflip_TimeOfDelivery_dispatch_sched_weekday_mget(SAM_Equpartflip ptr, int *nrows, int *ncols,
                                                           SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Equpartflip_TimeOfDelivery_dispatch_sched_weekend_mget(SAM_Equpartflip ptr, int *nrows, int *ncols,
                                                           SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_IRRTargets_tax_investor_preflip_tax_percent_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Equpartflip_Outputs_cf_effective_tax_frac_aget(SAM_Equpartflip ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Equpartflip_Outputs_cf_operating_expenses_aget(SAM_Equpartflip ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Equpartflip_Outputs_cf_sponsor_pretax_irr_aget(SAM_Equpartflip ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Equpartflip_Outputs_cf_sponsor_pretax_npv_aget(SAM_Equpartflip ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_custom_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_sl_15_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_sl_20_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_sl_39_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_total_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_sl_15_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_sl_20_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_sl_39_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_total_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_macrs_15_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_custom_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_sl_15_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_sl_20_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_sl_39_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_total_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_sl_15_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_sl_20_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_sl_39_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_total_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Equpartflip_Outputs_depr_stabas_percent_amount_macrs_15_nget(SAM_Equpartflip ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
