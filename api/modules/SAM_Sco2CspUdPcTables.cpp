...
SAM_EXPORT SAM_Sco2CspUdPcTables SAM_Sco2CspUdPcTables_construct(const char *def, SAM_error *err) {
    SAM_Sco2CspUdPcTables result = nullptr;
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_T_amb_des_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_T_htf_hot_des_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_W_dot_net_des_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_dT_PHX_hot_approach_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_dT_mc_approach_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_design_method_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_eta_thermal_des_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_htf_props_mset(SAM_Sco2CspUdPcTables ptr, double *mat, int nrows, int ncols,
                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_SystemDesign_site_elevation_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_HP_deltaP_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_LP_deltaP_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_UA_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "HTR_UA_des_in", number);
    });
}

SAM_EXPORT void SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_design_code_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                               SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_eff_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_min_dT_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HT_recup_eff_max_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_HP_deltaP_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_LP_deltaP_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_UA_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "LTR_UA_des_in", number);
    });
}

SAM_EXPORT void SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_design_code_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                               SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_eff_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_min_dT_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LT_recup_eff_max_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_UA_recup_tot_des_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_cycle_config_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_des_objective_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_IP_fixed_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_PR_fixed_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "is_PR_fixed", number);
    });
}

SAM_EXPORT void SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_P_high_fixed_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                               SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_recomp_ok_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "is_recomp_ok", number);
    });
}

SAM_EXPORT void SAM_Sco2CspUdPcTables_HeatExchangerDesign_min_phx_deltaT_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_rel_tol_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_CycleDesign_PHX_co2_deltaP_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_CycleDesign_P_high_limit_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_CycleDesign_deltaP_counterHX_frac_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_CycleDesign_eta_isen_mc_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_CycleDesign_eta_isen_pc_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_CycleDesign_eta_isen_rc_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_CycleDesign_eta_isen_t_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_PHXDesign_dT_PHX_cold_approach_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "dT_PHX_cold_approach", number);
    });
}

SAM_EXPORT void SAM_Sco2CspUdPcTables_AirCoolerDesign_deltaP_cooler_frac_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_AirCoolerDesign_fan_power_frac_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_AirCoolerDesign_is_design_air_cooler_nset(SAM_Sco2CspUdPcTables ptr, double number,
                                                                SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_T_htf_hot_high_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_T_htf_hot_low_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_is_apply_default_htf_mins_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_is_generate_udpc_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_m_dot_htf_ND_high_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_m_dot_htf_ND_low_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_n_T_htf_hot_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspUdPcTables_Common_n_m_dot_htf_ND_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_SystemDesign_dT_PHX_hot_approach_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_SystemDesign_htf_props_mget(SAM_Sco2CspUdPcTables ptr, int *nrows, int *ncols, SAM_error *err) {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_HP_deltaP_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_LP_deltaP_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_UA_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_design_code_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_eff_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_min_dT_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HT_recup_eff_max_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_HP_deltaP_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_LP_deltaP_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_UA_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_design_code_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_eff_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_min_dT_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LT_recup_eff_max_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_UA_recup_tot_des_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_cycle_config_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_des_objective_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_IP_fixed_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_PR_fixed_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_P_high_fixed_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_is_recomp_ok_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_HeatExchangerDesign_min_phx_deltaT_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_CycleDesign_PHX_co2_deltaP_des_in_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_CycleDesign_deltaP_counterHX_frac_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_AirCoolerDesign_deltaP_cooler_frac_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_AirCoolerDesign_is_design_air_cooler_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_Common_is_apply_default_htf_mins_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_Outputs_LP_cooler_co2_deltaP_des_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_Outputs_LP_cooler_in_isen_deltah_to_P_mc_out_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_P_mc_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_P_pc_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_P_rc_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_P_state_points_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_HTR_HP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_HTR_LP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_LTR_HP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_LTR_LP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_PHX_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_amb_ind_mget(SAM_Sco2CspUdPcTables ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_htf_ind_mget(SAM_Sco2CspUdPcTables ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_main_cooler_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_pre_cooler_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_T_state_points_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_Outputs_cycle_spec_cost_thermal_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_h_mc_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_h_pc_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_h_rc_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_h_state_points_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_m_dot_htf_ND_ind_mget(SAM_Sco2CspUdPcTables ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_mc_eta_stages_des_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_mc_tip_ratio_des_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_pc_eta_stages_des_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_pc_tip_ratio_des_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_rc_eta_stages_des_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_rc_tip_ratio_des_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_Outputs_recup_total_UA_assigned_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspUdPcTables_Outputs_recup_total_UA_calculated_nget(SAM_Sco2CspUdPcTables ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_HTR_HP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_HTR_LP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_LTR_HP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_LTR_LP_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_PHX_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_main_cooler_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_pre_cooler_data_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspUdPcTables_Outputs_s_state_points_aget(SAM_Sco2CspUdPcTables ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
