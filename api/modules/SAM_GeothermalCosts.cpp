...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_condensate_pump_power_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_conversion_type_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_cw_pump_head_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_cw_pump_work_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_eff_secondlaw_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_gross_output_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_hp_flash_pressure_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_lp_flash_pressure_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_ncg_condensate_pump_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_pressure_ratio_1_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_pressure_ratio_2_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_pressure_ratio_3_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_qRejectByStage_1_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_qRejectByStage_2_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_qRejectByStage_3_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_GeothermalCosts_GeoHourly_qRejectTotal_nset(SAM_GeothermalCosts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
