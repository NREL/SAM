...
SAM_EXPORT void
SAM_Sco2DesignPoint_Common_T_amb_array_aset(SAM_Sco2DesignPoint ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2DesignPoint_Common_part_load_fracs_aset(SAM_Sco2DesignPoint ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2DesignPoint_Common_run_off_des_study_nset(SAM_Sco2DesignPoint ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2DesignPoint_Common_part_load_fracs_aget(SAM_Sco2DesignPoint ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2DesignPoint_Outputs_T_amb_array_out_aget(SAM_Sco2DesignPoint ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2DesignPoint_Outputs_part_load_coefs_aget(SAM_Sco2DesignPoint ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2DesignPoint_Outputs_part_load_eta_aget(SAM_Sco2DesignPoint ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2DesignPoint_Outputs_part_load_fracs_out_aget(SAM_Sco2DesignPoint ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
