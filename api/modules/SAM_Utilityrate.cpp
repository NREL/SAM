...
SAM_EXPORT void
SAM_Utilityrate_Common_e_with_system_aset(SAM_Utilityrate ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate_Common_p_with_system_aset(SAM_Utilityrate ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Utilityrate_Common_ur_monthly_fixed_charge_nset(SAM_Utilityrate ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate_Outputs_elec_cost_with_system_aget(SAM_Utilityrate ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate_Outputs_year1_hourly_e_demand_aget(SAM_Utilityrate ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate_Outputs_year1_hourly_p_demand_aget(SAM_Utilityrate ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
