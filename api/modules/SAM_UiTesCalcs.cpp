...
SAM_EXPORT void
SAM_UiTesCalcs_Common_TES_HTF_props_mset(SAM_UiTesCalcs ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_UiTesCalcs_Common_TES_HTF_props_mget(SAM_UiTesCalcs ptr, int *nrows, int *ncols, SAM_error *err) {
