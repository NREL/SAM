...
SAM_EXPORT int SAM_Cashloan_execute(SAM_Cashloan data, int verbosity, SAM_error *err) {
    int n_err = 0;
    translateExceptions(err, [&] {
        n_err += SAM_module_exec("cashloan", data, verbosity, err);
    });
    return n_err;
}
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_federal_tax_rate_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_prop_tax_assessed_decline_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_prop_tax_cost_assessed_percent_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_property_tax_rate_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_real_discount_rate_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_salvage_percentage_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_state_tax_rate_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FinancialParameters_system_heat_rate_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_annual_fuel_usage_lifetime_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_opt_fuel_1_cost_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_opt_fuel_1_cost_escal_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_opt_fuel_2_cost_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_opt_fuel_2_cost_escal_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_production1_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_production1_values_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_production2_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_production2_values_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_replacement_cost1_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_replacement_cost2_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemCosts_om_replacement_cost_escal_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_Depreciation_depr_fed_custom_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_Depreciation_depr_sta_custom_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_fed_amount_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_fed_amount_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_fed_percent_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_fed_percent_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_fed_percent_maxvalue_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_sta_amount_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_sta_amount_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_sta_percent_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_sta_percent_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_itc_sta_percent_maxvalue_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_ptc_fed_amount_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_TaxCreditIncentives_ptc_sta_amount_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_fed_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_fed_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_oth_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_oth_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_sta_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_sta_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_uti_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_cbi_uti_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_amount_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_amount_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_amount_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_amount_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_percent_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_percent_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_percent_maxvalue_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_percent_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_fed_percent_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_amount_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_amount_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_amount_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_amount_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_percent_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_percent_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_percent_maxvalue_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_percent_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_oth_percent_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_amount_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_amount_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_amount_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_amount_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_percent_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_percent_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_percent_maxvalue_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_percent_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_sta_percent_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_amount_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_amount_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_amount_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_amount_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_percent_deprbas_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_percent_deprbas_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_percent_maxvalue_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_percent_tax_fed_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_ibi_uti_percent_tax_sta_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_pbi_fed_amount_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_pbi_oth_amount_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_pbi_sta_amount_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_PaymentIncentives_pbi_uti_amount_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_BatterySystem_batt_bank_replacement_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_BatterySystem_batt_computed_bank_capacity_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_BatterySystem_batt_replacement_option_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_BatterySystem_batt_replacement_schedule_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FuelCell_fuelcell_computed_bank_capacity_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FuelCell_fuelcell_replacement_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FuelCell_fuelcell_replacement_option_nset(SAM_Cashloan ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_FuelCell_fuelcell_replacement_schedule_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemOutput_annual_energy_value_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_SystemOutput_annual_themal_value_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_ThirdPartyOwnership_elec_cost_with_system_aset(SAM_Cashloan ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Cashloan_ThirdPartyOwnership_elec_cost_without_system_aset(SAM_Cashloan ptr, double *arr, int length,
                                                               SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_FinancialParameters_federal_tax_rate_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
...
SAM_EXPORT double
SAM_Cashloan_FinancialParameters_prop_tax_cost_assessed_percent_nget(SAM_Cashloan ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_SystemCosts_annual_fuel_usage_lifetime_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_capacity1_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_capacity1");
    });
    return result;
}
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_capacity2_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_capacity2");
    });
    return result;
}
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_fixed1_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_fixed1");
    });
    return result;
}
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_fixed2_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_fixed2");
    });
    return result;
}
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_production1_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_production1");
    });
    return result;
}
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_production2_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_production2");
    });
    return result;
}
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_replacement_cost1_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_replacement_cost1");
    });
    return result;
}
...
SAM_EXPORT double *SAM_Cashloan_SystemCosts_om_replacement_cost2_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    ...
    translateExceptions(err, [&] {
        ...
        if (!result)
            make_access_error("SAM_Cashloan", "om_replacement_cost2");
    });
    return result;
}
...
SAM_EXPORT double *
SAM_Cashloan_BatterySystem_batt_bank_replacement_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_BatterySystem_batt_replacement_schedule_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
        result = ssc_data_get_array(ptr, "batt_replacement_schedule", length);
        if (!result)
            make_access_error("SAM_Cashloan", "batt_replacement_schedule");
    });
    return result;
}
...
SAM_EXPORT double *
SAM_Cashloan_FuelCell_fuelcell_replacement_schedule_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_ThirdPartyOwnership_elec_cost_with_system_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_ThirdPartyOwnership_elec_cost_without_system_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_after_tax_net_equity_cost_flow_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_battery_replacement_cost_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_battery_replacement_cost_schedule_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_cumulative_payback_with_expenses_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_cumulative_payback_without_expenses_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_discounted_cumulative_payback_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_fed_incentive_income_less_deductions_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_fed_taxable_incentive_income_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_fed_taxable_income_less_deductions_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_fuelcell_replacement_cost_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_fuelcell_replacement_cost_schedule_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_payback_without_expenses_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_property_tax_assessed_value_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_sta_incentive_income_less_deductions_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_sta_taxable_incentive_income_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Cashloan_Outputs_cf_sta_taxable_income_less_deductions_aget(SAM_Cashloan ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
