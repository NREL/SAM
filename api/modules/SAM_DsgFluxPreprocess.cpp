...
SAM_EXPORT SAM_DsgFluxPreprocess SAM_DsgFluxPreprocess_construct(const char *def, SAM_error *err) {
    SAM_DsgFluxPreprocess result = nullptr;
...
SAM_EXPORT void
SAM_DsgFluxPreprocess_Common_P_cycle_des_nset(SAM_DsgFluxPreprocess ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_DsgFluxPreprocess_Common_max_flux_rh_nset(SAM_DsgFluxPreprocess ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_DsgFluxPreprocess_Common_max_flux_sh_nset(SAM_DsgFluxPreprocess ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_DsgFluxPreprocess_Common_rh_frac_ref_nset(SAM_DsgFluxPreprocess ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
