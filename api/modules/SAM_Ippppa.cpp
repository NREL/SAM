...
SAM_EXPORT void
SAM_Ippppa_FinancialParameters_federal_tax_rate_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_FinancialParameters_prop_tax_assessed_decline_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_FinancialParameters_prop_tax_cost_assessed_percent_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_FinancialParameters_state_tax_rate_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_SystemCosts_annual_fuel_usage_lifetime_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_SystemCosts_om_opt_fuel_1_cost_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_SystemCosts_om_opt_fuel_2_cost_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_SystemCosts_om_production1_values_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_SystemCosts_om_production2_values_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_SystemCosts_om_replacement_cost1_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_SystemCosts_om_replacement_cost2_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_fed_amount_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_fed_amount_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_fed_percent_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_fed_percent_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_fed_percent_maxvalue_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_sta_amount_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_sta_amount_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_sta_percent_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_sta_percent_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_itc_sta_percent_maxvalue_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_ptc_fed_amount_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_TaxCreditIncentives_ptc_sta_amount_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_amount_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_amount_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_amount_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_amount_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_percent_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_percent_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_percent_maxvalue_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_percent_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_fed_percent_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_amount_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_amount_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_amount_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_amount_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_percent_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_percent_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_percent_maxvalue_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_percent_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_oth_percent_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_amount_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_amount_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_amount_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_amount_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_percent_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_percent_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_percent_maxvalue_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_percent_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_sta_percent_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_amount_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_amount_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_amount_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_amount_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_percent_deprbas_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_percent_deprbas_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_percent_maxvalue_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_percent_tax_fed_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_ibi_uti_percent_tax_sta_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_pbi_fed_amount_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_pbi_oth_amount_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_pbi_sta_amount_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_PaymentIncentives_pbi_uti_amount_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_Common_dispatch_sched_weekday_mset(SAM_Ippppa ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_Common_dispatch_sched_weekend_mset(SAM_Ippppa ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_Common_system_recapitalization_boolean_aset(SAM_Ippppa ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Ippppa_Common_system_recapitalization_escalation_nset(SAM_Ippppa ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Common_dispatch_sched_weekday_mget(SAM_Ippppa ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Common_dispatch_sched_weekend_mget(SAM_Ippppa ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_after_tax_net_equity_cash_flow_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_after_tax_net_equity_cost_flow_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD1_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD2_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD3_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD4_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD5_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD6_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD7_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD8_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_energy_net_monthly_firstyear_TOD9_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_fed_incentive_income_less_deductions_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_fed_taxable_income_less_deductions_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD1_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD2_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD3_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD4_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD5_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD6_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD7_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD8_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_revenue_monthly_firstyear_TOD9_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_sta_incentive_income_less_deductions_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Ippppa_Outputs_cf_sta_taxable_income_less_deductions_aget(SAM_Ippppa ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
