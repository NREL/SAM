...
SAM_EXPORT void SAM_Pv6parmod_CEC6ParameterPVModuleModel_alpha_isc_nset(SAM_Pv6parmod ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_Pv6parmod_CEC6ParameterPVModuleModel_beta_voc_nset(SAM_Pv6parmod ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "beta_voc", number);
	});
}

SAM_EXPORT void SAM_Pv6parmod_CEC6ParameterPVModuleModel_gamma_pmp_nset(SAM_Pv6parmod ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_Pv6parmod_CEC6ParameterPVModuleModel_opvoltage_aset(SAM_Pv6parmod ptr, double* arr, int length, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_array(ptr, "opvoltage", arr, length);
	});
}

SAM_EXPORT void SAM_Pv6parmod_CEC6ParameterPVModuleModel_standoff_nset(SAM_Pv6parmod ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_Pv6parmod_CEC6ParameterPVModuleModel_opvoltage_aget(SAM_Pv6parmod ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
