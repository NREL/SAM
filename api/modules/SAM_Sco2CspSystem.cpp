...
SAM_EXPORT SAM_Sco2CspSystem SAM_Sco2CspSystem_construct(const char *def, SAM_error *err) {
    SAM_Sco2CspSystem result = nullptr;
...
SAM_EXPORT void
SAM_Sco2CspSystem_SystemDesign_T_htf_hot_des_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_SystemDesign_W_dot_net_des_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_SystemDesign_dT_PHX_hot_approach_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_SystemDesign_dT_mc_approach_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_SystemDesign_design_method_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_SystemDesign_eta_thermal_des_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Sco2CspSystem_SystemDesign_htf_props_mset(SAM_Sco2CspSystem ptr, double *mat, int nrows, int ncols,
                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_SystemDesign_site_elevation_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_HP_deltaP_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_LP_deltaP_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_UA_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_design_code_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_eff_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_min_dT_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_HT_recup_eff_max_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_HP_deltaP_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_LP_deltaP_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_UA_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_design_code_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_eff_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_min_dT_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_LT_recup_eff_max_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_UA_recup_tot_des_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_cycle_config_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_des_objective_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_is_IP_fixed_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_is_PR_fixed_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_is_P_high_fixed_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_is_recomp_ok_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_min_phx_deltaT_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_HeatExchangerDesign_rel_tol_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_CycleDesign_PHX_co2_deltaP_des_in_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_CycleDesign_deltaP_counterHX_frac_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_PHXDesign_dT_PHX_cold_approach_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_AirCoolerDesign_deltaP_cooler_frac_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_AirCoolerDesign_fan_power_frac_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_AirCoolerDesign_is_design_air_cooler_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_Common_is_gen_od_polynomials_nset(SAM_Sco2CspSystem ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_Common_od_P_mc_in_sweep_aset(SAM_Sco2CspSystem ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_Common_od_cases_mset(SAM_Sco2CspSystem ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_Common_od_generate_udpc_aset(SAM_Sco2CspSystem ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Sco2CspSystem_Common_od_set_control_mset(SAM_Sco2CspSystem ptr, double *mat, int nrows, int ncols, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_SystemDesign_htf_props_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
...
SAM_EXPORT double
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_HP_deltaP_des_in_nget(SAM_Sco2CspSystem ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspSystem_HeatExchangerDesign_HTR_LP_deltaP_des_in_nget(SAM_Sco2CspSystem ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_HP_deltaP_des_in_nget(SAM_Sco2CspSystem ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspSystem_HeatExchangerDesign_LTR_LP_deltaP_des_in_nget(SAM_Sco2CspSystem ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Common_od_cases_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Common_od_set_control_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_IP_cooler_W_dot_fan_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_LP_cooler_T_in_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_LP_cooler_W_dot_fan_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_LP_cooler_co2_deltaP_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Sco2CspSystem_Outputs_LP_cooler_in_isen_deltah_to_P_mc_out_nget(SAM_Sco2CspSystem ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_LP_cooler_in_isen_deltah_to_P_mc_out_od_aget(SAM_Sco2CspSystem ptr, int *length,
                                                                       SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_LP_cooler_rho_in_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_T_main_cooler_data_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_T_pre_cooler_data_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_cooler_tot_W_dot_fan_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_deltaT_HTF_PHX_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_m_dot_co2_full_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_mc_eta_stages_des_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_mc_eta_stages_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_mc_ideal_spec_work_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_mc_phi_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_mc_psi_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_mc_tip_ratio_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_pc_eta_stages_des_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_pc_eta_stages_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_pc_ideal_spec_work_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_pc_phi_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_pc_tip_ratio_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_phx_co2_deltaP_od_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_rc_eta_stages_des_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_rc_eta_stages_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_rc_phi_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_rc_psi_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_rc_tip_ratio_od_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_s_main_cooler_data_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_s_pre_cooler_data_aget(SAM_Sco2CspSystem ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Sco2CspSystem_Outputs_udpc_table_mget(SAM_Sco2CspSystem ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
