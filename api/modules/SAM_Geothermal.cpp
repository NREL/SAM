...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_geothermal_analysis_period_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_hybrid_dispatch_schedule_sset(SAM_Geothermal ptr, const char *str, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_inj_prod_well_distance_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_plant_efficiency_input_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_reservoir_permeability_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_reservoir_pressure_change_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_reservoir_pressure_change_type_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_rock_thermal_conductivity_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_specified_pump_work_amount_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Geothermal_GeoHourly_system_use_lifetime_output_nset(SAM_Geothermal ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Geothermal_Outputs_monthly_resource_temperature_aget(SAM_Geothermal ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Geothermal_Outputs_system_lifetime_recapitalize_aget(SAM_Geothermal ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Geothermal_Outputs_timestep_resource_temperature_aget(SAM_Geothermal ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
