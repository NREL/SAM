...
SAM_EXPORT void
SAM_Battwatts_Lifetime_system_use_lifetime_output_nset(SAM_Battwatts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Battwatts_Battery_batt_custom_dispatch_aset(SAM_Battwatts ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Battwatts_Battery_batt_simple_meter_position_nset(SAM_Battwatts ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_annual_export_to_grid_energy_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_annual_import_to_grid_energy_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_annual_charge_energy_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_annual_charge_from_grid_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_annual_charge_from_pv_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_annual_discharge_energy_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_annual_energy_system_loss_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_capacity_percent_calendar_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_capacity_percent_cycle_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_capacity_thermal_percent_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_batt_dispatch_sched_mget(SAM_Battwatts ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Battwatts_Outputs_market_sell_rate_series_yr1_aget(SAM_Battwatts ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
