...
SAM_EXPORT void
SAM_Solarpilot_SolarPILOT_helio_active_fraction_nset(SAM_Solarpilot ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Solarpilot_SolarPILOT_helio_positions_in_mset(SAM_Solarpilot ptr, double *mat, int nrows, int ncols,
                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Solarpilot_SolarPILOT_solar_resource_file_sset(SAM_Solarpilot ptr, const char *str, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Solarpilot_SolarPILOT_helio_positions_in_mget(SAM_Solarpilot ptr, int *nrows, int *ncols, SAM_error *err) {
...
SAM_EXPORT double *
SAM_Solarpilot_Outputs_heliostat_positions_mget(SAM_Solarpilot ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Solarpilot_Outputs_opteff_table_mget(SAM_Solarpilot ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
