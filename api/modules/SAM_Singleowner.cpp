...
SAM_EXPORT void
SAM_Singleowner_Revenue_dispatch_factors_ts_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Revenue_dispatch_sched_weekday_mset(SAM_Singleowner ptr, double *mat, int nrows, int ncols,
                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Revenue_dispatch_sched_weekend_mset(SAM_Singleowner ptr, double *mat, int nrows, int ncols,
                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Revenue_ppa_price_input_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Revenue_ppa_soln_max_iterations_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_analysis_period_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "analysis_period", number);
    });
}

SAM_EXPORT void SAM_Singleowner_FinancialParameters_construction_financing_cost_nset(SAM_Singleowner ptr, double number,
                                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_cost_debt_closing_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_cost_debt_fee_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_cost_other_financing_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_debt_option_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_debt_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_dscr_reserve_months_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip1_reserve_cost_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip1_reserve_freq_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip2_reserve_cost_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip2_reserve_freq_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip3_reserve_cost_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip3_reserve_freq_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip_reserve_depr_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_equip_reserve_depr_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "equip_reserve_depr_sta", number);
    });
}

SAM_EXPORT void SAM_Singleowner_FinancialParameters_federal_tax_rate_aset(SAM_Singleowner ptr, double *arr, int length,
                                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_inflation_rate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_insurance_rate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_loan_moratorium_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "loan_moratorium", number);
    });
}

SAM_EXPORT void SAM_Singleowner_FinancialParameters_months_receivables_reserve_nset(SAM_Singleowner ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_months_working_reserve_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_payment_option_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_prop_tax_assessed_decline_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_prop_tax_cost_assessed_percent_nset(SAM_Singleowner ptr, double number,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_property_tax_rate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_real_discount_rate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_reserves_interest_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_roe_input_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_salvage_percentage_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_state_tax_rate_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_system_capacity_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_system_heat_rate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_term_int_rate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FinancialParameters_term_tenor_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_annual_fuel_usage_lifetime_aset(SAM_Singleowner ptr, double *arr, int length,
                                                            SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_capacity_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_capacity1_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_capacity1_nameplate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_capacity2_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_capacity2_nameplate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_fixed_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_fixed1_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_fixed2_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_fuel_cost_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_fuel_cost_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_opt_fuel_1_cost_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_opt_fuel_1_cost_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_opt_fuel_1_usage_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_opt_fuel_2_cost_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_opt_fuel_2_cost_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_opt_fuel_2_usage_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_production_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_production1_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_production1_values_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_production2_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_production2_values_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_production_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_replacement_cost1_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_replacement_cost2_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_om_replacement_cost_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_system_lifetime_recapitalize_aset(SAM_Singleowner ptr, double *arr, int length,
                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_system_recapitalization_cost_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "system_recapitalization_cost", number);
    });
}

SAM_EXPORT void SAM_Singleowner_SystemCosts_system_recapitalization_escalation_nset(SAM_Singleowner ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_system_use_recapitalization_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemCosts_total_installed_cost_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_itc_fed_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "itc_fed_amount", number);
    });
}

SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_fed_amount_deprbas_fed_nset(SAM_Singleowner ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_fed_amount_deprbas_sta_nset(SAM_Singleowner ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_itc_fed_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "itc_fed_percent", number);
    });
}

SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_fed_percent_deprbas_fed_nset(SAM_Singleowner ptr, double number,
                                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_fed_percent_deprbas_sta_nset(SAM_Singleowner ptr, double number,
                                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_itc_fed_percent_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_itc_sta_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "itc_sta_amount", number);
    });
}

SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_sta_amount_deprbas_fed_nset(SAM_Singleowner ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_sta_amount_deprbas_sta_nset(SAM_Singleowner ptr, double number,
                                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_itc_sta_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "itc_sta_percent", number);
    });
}

SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_sta_percent_deprbas_fed_nset(SAM_Singleowner ptr, double number,
                                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Singleowner_TaxCreditIncentives_itc_sta_percent_deprbas_sta_nset(SAM_Singleowner ptr, double number,
                                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_itc_sta_percent_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_ptc_fed_amount_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_ptc_fed_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_ptc_fed_term_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_ptc_sta_amount_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_ptc_sta_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_TaxCreditIncentives_ptc_sta_term_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_alloc_custom_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_alloc_macrs_15_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_alloc_macrs_5_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_alloc_sl_15_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_alloc_sl_20_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_alloc_sl_39_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_alloc_sl_5_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_fed_custom_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_fed_macrs_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_fed_macrs_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_fed_sl_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_fed_sl_20_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_fed_sl_39_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_fed_sl_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_sta_custom_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_sta_macrs_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_sta_macrs_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_sta_sl_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_sta_sl_20_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_sta_sl_39_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_bonus_sta_sl_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_custom_schedule_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_fedbas_method_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_fed_custom_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_fed_macrs_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_fed_macrs_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_fed_sl_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_fed_sl_20_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_fed_sl_39_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_fed_sl_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_sta_custom_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_sta_macrs_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_sta_macrs_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_sta_sl_15_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_sta_sl_20_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_sta_sl_39_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_itc_sta_sl_5_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Depreciation_depr_stabas_method_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_fed_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_fed_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_fed_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_fed_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_fed_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_fed_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_oth_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_oth_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_oth_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_oth_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_oth_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_oth_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_sta_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_sta_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_sta_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_sta_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_sta_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_sta_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_uti_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_uti_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_uti_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_uti_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_uti_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_cbi_uti_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_amount_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_amount_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_amount_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_amount_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_amount_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_amount_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_amount_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_amount_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_amount_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_amount_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_amount_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_amount_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_amount_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_amount_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_amount_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_amount_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_amount_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_deprbas_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_deprbas_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_maxvalue_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_fed_amount_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_fed_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_fed_for_ds_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_fed_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_fed_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_fed_term_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_oth_amount_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_oth_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_oth_for_ds_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_oth_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_oth_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_oth_term_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_sta_amount_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_sta_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_sta_for_ds_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_sta_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_sta_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_sta_term_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_uti_amount_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_uti_escal_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_uti_for_ds_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_uti_tax_fed_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_uti_tax_sta_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_PaymentIncentives_pbi_uti_term_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_BatterySystem_batt_bank_replacement_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_BatterySystem_batt_computed_bank_capacity_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_BatterySystem_batt_meter_position_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_BatterySystem_batt_replacement_option_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_BatterySystem_batt_replacement_schedule_aset(SAM_Singleowner ptr, double *arr, int length,
                                                             SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_BatterySystem_grid_to_batt_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_ElectricityRates_en_electricity_rates_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemOutput_annual_energy_pre_curtailment_ac_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemOutput_degradation_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_SystemOutput_system_pre_curtailment_kwac_aset(SAM_Singleowner ptr, double *arr, int length,
                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_UtilityBill_utility_bill_w_sys_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_Lifetime_system_use_lifetime_output_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FuelCell_fuelcell_computed_bank_capacity_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FuelCell_fuelcell_replacement_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FuelCell_fuelcell_replacement_option_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_FuelCell_fuelcell_replacement_schedule_aset(SAM_Singleowner ptr, double *arr, int length,
                                                            SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_CapacityPayments_cp_battery_nameplate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_CapacityPayments_cp_capacity_credit_percent_aset(SAM_Singleowner ptr, double *arr, int length,
                                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_CapacityPayments_cp_capacity_payment_amount_aset(SAM_Singleowner ptr, double *arr, int length,
                                                                 SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_CapacityPayments_cp_capacity_payment_esc_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_CapacityPayments_cp_capacity_payment_type_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_CapacityPayments_cp_system_nameplate_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_GridLimits_grid_curtailment_price_aset(SAM_Singleowner ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singleowner_GridLimits_grid_curtailment_price_esc_nset(SAM_Singleowner ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Revenue_dispatch_sched_weekday_mget(SAM_Singleowner ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Revenue_dispatch_sched_weekend_mget(SAM_Singleowner ptr, int *nrows, int *ncols, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_FinancialParameters_construction_financing_cost_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_FinancialParameters_federal_tax_rate_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_FinancialParameters_months_receivables_reserve_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_FinancialParameters_prop_tax_assessed_decline_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_FinancialParameters_prop_tax_cost_assessed_percent_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_FinancialParameters_roe_input_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_FinancialParameters_state_tax_rate_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_annual_fuel_usage_lifetime_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_om_opt_fuel_1_cost_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_om_opt_fuel_2_cost_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_om_production1_values_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_om_production2_values_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_om_replacement_cost1_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_om_replacement_cost2_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemCosts_system_lifetime_recapitalize_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_SystemCosts_system_recapitalization_escalation_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_fed_amount_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_fed_amount_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_fed_percent_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_fed_percent_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_fed_percent_maxvalue_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_sta_amount_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_sta_amount_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_sta_percent_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_sta_percent_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_TaxCreditIncentives_itc_sta_percent_maxvalue_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_TaxCreditIncentives_ptc_fed_amount_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_TaxCreditIncentives_ptc_sta_amount_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Depreciation_depr_custom_schedule_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_fed_amount_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_fed_amount_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_fed_percent_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_oth_amount_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_oth_amount_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_oth_percent_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_sta_amount_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_sta_amount_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_sta_percent_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_uti_amount_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_uti_amount_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_deprbas_fed_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_PaymentIncentives_ibi_uti_percent_deprbas_sta_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_PaymentIncentives_pbi_fed_amount_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_PaymentIncentives_pbi_oth_amount_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_PaymentIncentives_pbi_sta_amount_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_PaymentIncentives_pbi_uti_amount_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_BatterySystem_batt_bank_replacement_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_BatterySystem_batt_replacement_schedule_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_SystemOutput_annual_energy_pre_curtailment_ac_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_SystemOutput_system_pre_curtailment_kwac_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_UtilityBill_utility_bill_w_sys_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_FuelCell_fuelcell_replacement_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_FuelCell_fuelcell_replacement_schedule_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_CapacityPayments_cp_capacity_credit_percent_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_CapacityPayments_cp_capacity_payment_amount_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_GridLimits_grid_curtailment_price_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_battery_replacement_cost_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_battery_replacement_cost_schedule_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_debt_payment_interest_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_debt_payment_principal_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_debt_payment_total_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_disbursement_debtservice_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_disbursement_equip1_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_disbursement_equip2_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_disbursement_equip3_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_disbursement_receivables_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_effective_tax_frac_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch1_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch2_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch3_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch4_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch5_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch6_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch7_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch8_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_dispatch9_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD1_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD2_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD3_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD4_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD5_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD6_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD7_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD8_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_energy_net_monthly_firstyear_TOD9_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_fedtax_income_prior_incentives_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_fedtax_income_with_incentives_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_fedtax_taxable_incentives_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_fuelcell_replacement_cost_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_fuelcell_replacement_cost_schedule_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_funding_debtservice_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_funding_receivables_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_capacity1_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_capacity2_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_capacity_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_opt_fuel_1_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_opt_fuel_2_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_production1_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_production2_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_om_production_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_operating_expenses_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_financing_activities_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_investing_activities_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_operating_activities_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_receivablesra_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_aftertax_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_aftertax_cash_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_aftertax_irr_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_aftertax_max_irr_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_aftertax_npv_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_pretax_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_pretax_irr_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_project_return_pretax_npv_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_property_tax_assessed_value_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_property_tax_expense_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_pv_interest_factor_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_reserve_debtservice_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_reserve_receivables_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_return_on_equity_dollars_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_return_on_equity_input_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD1_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD2_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD3_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD4_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD5_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD6_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD7_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD8_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_revenue_monthly_firstyear_TOD9_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_statax_income_prior_incentives_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_statax_income_with_incentives_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Singleowner_Outputs_cf_statax_taxable_incentives_aget(SAM_Singleowner ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_first_year_bonus_custom_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_first_year_bonus_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_first_year_bonus_macrs_5_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_fed_reduction_custom_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_fed_reduction_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_fed_reduction_macrs_5_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_fed_reduction_sl_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_fed_reduction_sl_20_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_fed_reduction_sl_39_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_fed_reduction_total_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_sta_reduction_custom_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_sta_reduction_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_sta_reduction_macrs_5_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_sta_reduction_sl_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_sta_reduction_sl_20_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_sta_reduction_sl_39_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_itc_sta_reduction_total_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_fedbas_percent_amount_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_first_year_bonus_custom_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_first_year_bonus_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_first_year_bonus_macrs_5_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_fed_reduction_custom_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_fed_reduction_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_fed_reduction_macrs_5_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_fed_reduction_sl_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_fed_reduction_sl_20_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_fed_reduction_sl_39_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_fed_reduction_total_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_sta_reduction_custom_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_sta_reduction_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_sta_reduction_macrs_5_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_sta_reduction_sl_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_sta_reduction_sl_20_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_sta_reduction_sl_39_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_itc_sta_reduction_total_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Singleowner_Outputs_depr_stabas_percent_amount_macrs_15_nget(SAM_Singleowner ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
