...
SAM_EXPORT SAM_Singlediodeparams SAM_Singlediodeparams_construct(const char *def, SAM_error *err) {
    SAM_Singlediodeparams result = nullptr;
...
SAM_EXPORT int SAM_Singlediodeparams_execute(SAM_Singlediodeparams data, int verbosity, SAM_error *err) {
    int n_err = 0;
    translateExceptions(err, [&] {
        n_err += SAM_module_exec("singlediodeparams", data, verbosity, err);
    });
    return n_err;
}
...
SAM_EXPORT void
SAM_Singlediodeparams_SingleDiodeModel_I_nset(SAM_Singlediodeparams ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Singlediodeparams_SingleDiodeModel_T_nset(SAM_Singlediodeparams ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
