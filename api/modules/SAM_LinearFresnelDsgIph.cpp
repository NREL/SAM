...
SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_AbsorberMaterial_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "AbsorberMaterial", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_AnnulusGas_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "AnnulusGas", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_ColAz_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "ColAz", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_D_2_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "D_2", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_D_3_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "D_3", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_D_4_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "D_4", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_D_5_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "D_5", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_D_p_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "D_p", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_Design_loss_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "Design_loss", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_Dirt_HCE_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "Dirt_HCE", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_EPSILON_4_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "EPSILON_4", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_Flow_type_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "Flow_type", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_GeomEffects_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "GeomEffects", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_GlazingIntactIn_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "GlazingIntactIn", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_HCE_FieldFrac_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "HCE_FieldFrac", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_HLCharType_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "HLCharType", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_HL_W_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "HL_W", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_HL_dT_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "HL_dT", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_IAM_L_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "IAM_L", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_IAM_T_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "IAM_T", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_I_bn_des_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "I_bn_des", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_L_col_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "L_col", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_OptCharType_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "OptCharType", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_P_a_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "P_a", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_P_turb_des_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "P_turb_des", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_Pipe_hl_coef_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "Pipe_hl_coef", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_Rough_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "Rough", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_SCA_drives_elec_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "SCA_drives_elec", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_Shadowing_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "Shadowing", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_T_amb_des_sf_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_amb_des_sf", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_T_fp_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_fp", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_Tau_envelope_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "Tau_envelope", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_TrackingError_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "TrackingError", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_V_wind_max_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "V_wind_max", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_alpha_abs_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "alpha_abs", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_alpha_env_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "alpha_env", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_b_OpticalTable_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "b_OpticalTable", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE1_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "b_eps_HCE1", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE2_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "b_eps_HCE2", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE3_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "b_eps_HCE3", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE4_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "b_eps_HCE4", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_dirt_mirror_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "dirt_mirror", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_e_startup_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "e_startup", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_error_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "error", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_eta_pump_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "eta_pump", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_fP_hdr_c_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "fP_hdr_c", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_fP_hdr_h_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "fP_hdr_h", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_fP_sf_boil_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "fP_sf_boil", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_nLoops_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "nLoops", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_nModBoil_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "nModBoil", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_q_pb_des_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "q_pb_des", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_rho_mirror_clean_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "rho_mirror_clean", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_sh_OpticalTable_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "sh_OpticalTable", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE1_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "sh_eps_HCE1", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE2_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "sh_eps_HCE2", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE3_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "sh_eps_HCE3", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE4_mset(SAM_LinearFresnelDsgIph ptr, double* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "sh_eps_HCE4", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_theta_dep_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "theta_dep", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_theta_stow_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "theta_stow", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Solarfield_x_b_des_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "x_b_des", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Powerblock_T_cold_ref_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_cold_ref", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Powerblock_T_hot_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_hot", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Heliostat_csp_lf_sf_washes_per_year_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.lf.sf.washes_per_year", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_Heliostat_csp_lf_sf_water_per_wash_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.lf.sf.water_per_wash", number);
	});
}

SAM_EXPORT void SAM_LinearFresnelDsgIph_HeatSink_heat_sink_dP_frac_nset(SAM_LinearFresnelDsgIph ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_A_aperture_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_AbsorberMaterial_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_AnnulusGas_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_D_2_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_D_3_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_D_4_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_D_5_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_D_p_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_Design_loss_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_Dirt_HCE_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_EPSILON_4_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_Flow_type_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_GeomEffects_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_GlazingIntactIn_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_HCE_FieldFrac_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_HLCharType_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_HL_W_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_HL_dT_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_IAM_L_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_IAM_T_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_L_col_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_OptCharType_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_P_a_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_Rough_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_Shadowing_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_Tau_envelope_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_TrackingError_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_alpha_abs_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_alpha_env_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_b_OpticalTable_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE1_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE2_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE3_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE4_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_dirt_mirror_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_error_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_rho_mirror_clean_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_sh_OpticalTable_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE1_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE2_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE3_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Solarfield_sh_eps_HCE4_mget(SAM_LinearFresnelDsgIph ptr, int* nrows, int* ncols, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_LinearFresnelDsgIph_Heliostat_csp_lf_sf_washes_per_year_nget(SAM_LinearFresnelDsgIph ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_LinearFresnelDsgIph_Heliostat_csp_lf_sf_water_per_wash_nget(SAM_LinearFresnelDsgIph ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_T_field_cold_in_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_T_field_hot_out_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_T_rec_cold_in_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_T_rec_hot_out_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_W_dot_field_pump_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_W_dot_heat_sink_pump_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_W_dot_parasitic_tot_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_W_dot_sca_track_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_LinearFresnelDsgIph_Outputs_annual_electricity_consumption_nget(SAM_LinearFresnelDsgIph ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_LinearFresnelDsgIph_Outputs_annual_thermal_consumption_nget(SAM_LinearFresnelDsgIph ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_LinearFresnelDsgIph_Outputs_annual_total_water_use_nget(SAM_LinearFresnelDsgIph ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_e_dot_field_int_energy_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_eta_opt_ave_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_m_dot_loop_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_op_mode_1_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_op_mode_2_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_op_mode_3_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_dot_freeze_prot_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_dot_piping_loss_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_dot_rec_abs_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_dot_rec_inc_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_dot_rec_thermal_loss_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_dot_sf_out_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_dot_to_heat_sink_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_q_inc_sf_tot_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_solazi_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_solzen_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_theta_longitudinal_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_theta_traverse_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_time_hr_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_x_field_hot_out_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_LinearFresnelDsgIph_Outputs_x_rec_hot_out_aget(SAM_LinearFresnelDsgIph ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
