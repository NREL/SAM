...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Solarfield_A_aperture_mget(SAM_LinearFresnelDsgIph ptr, int *nrows, int *ncols,
                                                   SAM_error *err) {
...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Solarfield_AnnulusGas_mget(SAM_LinearFresnelDsgIph ptr, int *nrows, int *ncols,
                                                   SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Solarfield_HLCharType_mget(SAM_LinearFresnelDsgIph ptr, int *nrows, int *ncols,
                                                   SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE1_mget(SAM_LinearFresnelDsgIph ptr, int *nrows, int *ncols,
                                                   SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE2_mget(SAM_LinearFresnelDsgIph ptr, int *nrows, int *ncols,
                                                   SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE3_mget(SAM_LinearFresnelDsgIph ptr, int *nrows, int *ncols,
                                                   SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Solarfield_b_eps_HCE4_mget(SAM_LinearFresnelDsgIph ptr, int *nrows, int *ncols,
                                                   SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_LinearFresnelDsgIph_Outputs_annual_field_energy_nget(SAM_LinearFresnelDsgIph ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_LinearFresnelDsgIph_Outputs_month_aget(SAM_LinearFresnelDsgIph ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
