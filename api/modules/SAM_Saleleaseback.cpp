...
SAM_EXPORT void
SAM_Saleleaseback_Revenue_ppa_price_input_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Revenue_ppa_soln_max_iterations_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Revenue_ppa_soln_tolerance_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_analysis_period_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_equip1_reserve_cost_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_equip1_reserve_freq_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_equip2_reserve_cost_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_equip2_reserve_freq_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_equip3_reserve_cost_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_equip3_reserve_freq_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "equip3_reserve_freq", number);
    });
}

SAM_EXPORT void SAM_Saleleaseback_FinancialParameters_equip_reserve_depr_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Saleleaseback_FinancialParameters_equip_reserve_depr_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_federal_tax_rate_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                            SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_inflation_rate_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_insurance_rate_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_prop_tax_assessed_decline_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_prop_tax_cost_assessed_percent_nset(SAM_Saleleaseback ptr, double number,
                                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_property_tax_rate_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_real_discount_rate_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_reserves_interest_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_state_tax_rate_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_system_capacity_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_FinancialParameters_system_heat_rate_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_add_om_num_types_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_annual_fuel_usage_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_annual_fuel_usage_lifetime_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                              SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_capacity_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_capacity1_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_capacity1_nameplate_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_capacity2_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_capacity2_nameplate_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_capacity_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_fixed_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_fixed1_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_fixed2_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_fixed_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_fuel_cost_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_fuel_cost_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_opt_fuel_1_cost_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_opt_fuel_1_cost_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_opt_fuel_1_usage_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_opt_fuel_2_cost_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_opt_fuel_2_cost_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_opt_fuel_2_usage_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_production_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_production1_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_array(ptr, "om_production1", arr, length);
    });
}

SAM_EXPORT void SAM_Saleleaseback_SystemCosts_om_production1_values_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_production2_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_array(ptr, "om_production2", arr, length);
    });
}

SAM_EXPORT void SAM_Saleleaseback_SystemCosts_om_production2_values_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_production_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "om_production_escal", number);
    });
}

SAM_EXPORT void SAM_Saleleaseback_SystemCosts_om_replacement_cost1_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Saleleaseback_SystemCosts_om_replacement_cost2_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemCosts_om_replacement_cost_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_amount_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                      SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_amount_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                      SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_percent_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_percent_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_percent_maxvalue_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_amount_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                      SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_amount_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                      SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_percent_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_percent_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                       SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_percent_maxvalue_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_ptc_fed_amount_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_ptc_fed_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_ptc_fed_term_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_ptc_sta_amount_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_ptc_sta_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TaxCreditIncentives_ptc_sta_term_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_alloc_custom_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_alloc_macrs_15_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_alloc_macrs_5_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_alloc_sl_15_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_alloc_sl_20_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_alloc_sl_39_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_alloc_sl_5_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_custom_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_macrs_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_macrs_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_sl_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_sl_20_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_sl_39_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_fed_sl_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_custom_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_macrs_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_macrs_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_sl_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_sl_20_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_sl_39_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_bonus_sta_sl_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "depr_bonus_sta_sl_5", number);
    });
}

SAM_EXPORT void SAM_Saleleaseback_Depreciation_depr_custom_schedule_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_fed_custom_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_fed_macrs_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_fed_macrs_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_fed_sl_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_fed_sl_20_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_fed_sl_39_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_fed_sl_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_sta_custom_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_sta_macrs_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_sta_macrs_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_sta_sl_15_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_sta_sl_20_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_sta_sl_39_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_Depreciation_depr_itc_sta_sl_5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_fed_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_fed_deprbas_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_fed_deprbas_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_fed_maxvalue_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_fed_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_fed_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_oth_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_oth_deprbas_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_oth_deprbas_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_oth_maxvalue_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_oth_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_oth_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_sta_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_sta_deprbas_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_sta_deprbas_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_sta_maxvalue_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_sta_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_sta_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_uti_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_uti_deprbas_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_uti_deprbas_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_uti_maxvalue_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_uti_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_cbi_uti_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_maxvalue_nset(SAM_Saleleaseback ptr, double number,
                                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_maxvalue_nset(SAM_Saleleaseback ptr, double number,
                                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_maxvalue_nset(SAM_Saleleaseback ptr, double number,
                                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_deprbas_fed_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_deprbas_sta_nset(SAM_Saleleaseback ptr, double number,
                                                                     SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_maxvalue_nset(SAM_Saleleaseback ptr, double number,
                                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "ibi_uti_percent_tax_sta", number);
    });
}

SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_pbi_fed_amount_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_fed_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_fed_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_fed_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_fed_term_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "pbi_fed_term", number);
    });
}

SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_pbi_oth_amount_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_oth_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_oth_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_oth_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_oth_term_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "pbi_oth_term", number);
    });
}

SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_pbi_sta_amount_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_sta_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_sta_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_sta_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_sta_term_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "pbi_sta_term", number);
    });
}

SAM_EXPORT void SAM_Saleleaseback_PaymentIncentives_pbi_uti_amount_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_uti_escal_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_uti_tax_fed_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_uti_tax_sta_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_PaymentIncentives_pbi_uti_term_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemOutput_degradation_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemOutput_gen_aset(SAM_Saleleaseback ptr, double *arr, int length, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SystemOutput_system_capacity_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
        ssc_data_set_number(ptr, "system_capacity", number);
    });
}
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_construction_financing_cost_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_cost_dev_fee_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_cost_equity_closing_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_cost_other_financing_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_depr_fedbas_method_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_depr_stabas_method_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_flip_target_percent_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_flip_target_year_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_salvage_percentage_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_sponsor_operating_margin_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_sponsor_operating_margin_escalation_nset(SAM_Saleleaseback ptr, double number,
                                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_system_lifetime_recapitalize_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void SAM_Saleleaseback_SaleLeaseback_system_recapitalization_cost_nset(SAM_Saleleaseback ptr, double number,
                                                                                  SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_system_recapitalization_escalation_nset(SAM_Saleleaseback ptr, double number,
                                                                        SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_system_use_lifetime_output_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_system_use_recapitalization_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_tax_investor_required_lease_reserve_nset(SAM_Saleleaseback ptr, double number,
                                                                         SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_SaleLeaseback_total_installed_cost_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor1_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor2_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor3_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor4_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor5_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor6_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor7_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor8_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factor9_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_factors_ts_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                          SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_sched_weekday_mset(SAM_Saleleaseback ptr, double *mat, int nrows, int ncols,
                                                             SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_dispatch_sched_weekend_mset(SAM_Saleleaseback ptr, double *mat, int nrows, int ncols,
                                                             SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_TimeOfDelivery_ppa_multiplier_model_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_OtherCapitalCosts_months_receivables_reserve_nset(SAM_Saleleaseback ptr, double number,
                                                                    SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_OtherCapitalCosts_months_working_reserve_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_BatterySystem_batt_bank_replacement_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                           SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_BatterySystem_batt_computed_bank_capacity_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_BatterySystem_batt_replacement_option_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_BatterySystem_batt_replacement_schedule_aset(SAM_Saleleaseback ptr, double *arr, int length,
                                                               SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT void
SAM_Saleleaseback_BatterySystem_battery_per_kWh_nset(SAM_Saleleaseback ptr, double number, SAM_error *err) {
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip1_reserve_cost_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip1_reserve_freq_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip2_reserve_cost_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip2_reserve_freq_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip3_reserve_cost_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip3_reserve_freq_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip_reserve_depr_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_equip_reserve_depr_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_FinancialParameters_federal_tax_rate_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_prop_tax_assessed_decline_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_FinancialParameters_prop_tax_cost_assessed_percent_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_FinancialParameters_state_tax_rate_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_annual_fuel_usage_lifetime_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_opt_fuel_1_cost_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_opt_fuel_2_cost_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_production_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_production1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_production1_values_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_production2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_production2_values_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_replacement_cost1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SystemCosts_om_replacement_cost2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_amount_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_amount_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_percent_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_percent_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_fed_percent_maxvalue_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_amount_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_amount_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_percent_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_percent_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_TaxCreditIncentives_itc_sta_percent_maxvalue_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_TaxCreditIncentives_ptc_fed_amount_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_TaxCreditIncentives_ptc_sta_amount_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Depreciation_depr_alloc_macrs_15_percent_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Depreciation_depr_alloc_macrs_5_percent_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Depreciation_depr_custom_schedule_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_amount_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_maxvalue_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_fed_percent_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_amount_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_maxvalue_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_oth_percent_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_amount_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_maxvalue_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_sta_percent_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_amount_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_deprbas_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_deprbas_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_maxvalue_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_tax_fed_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_PaymentIncentives_ibi_uti_percent_tax_sta_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_PaymentIncentives_pbi_fed_amount_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_PaymentIncentives_pbi_oth_amount_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_PaymentIncentives_pbi_sta_amount_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_PaymentIncentives_pbi_uti_amount_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_SaleLeaseback_construction_financing_cost_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_SaleLeaseback_sponsor_operating_margin_escalation_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_SaleLeaseback_system_lifetime_recapitalize_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_SaleLeaseback_system_recapitalization_cost_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_SaleLeaseback_system_recapitalization_escalation_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_SaleLeaseback_system_use_lifetime_output_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_SaleLeaseback_system_use_recapitalization_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_SaleLeaseback_tax_investor_required_lease_reserve_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_TimeOfDelivery_dispatch_factors_ts_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_TimeOfDelivery_dispatch_sched_weekday_mget(SAM_Saleleaseback ptr, int *nrows, int *ncols,
                                                             SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_TimeOfDelivery_dispatch_sched_weekend_mget(SAM_Saleleaseback ptr, int *nrows, int *ncols,
                                                             SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_OtherCapitalCosts_months_receivables_reserve_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_OtherCapitalCosts_months_working_reserve_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_BatterySystem_batt_bank_replacement_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_BatterySystem_batt_computed_bank_capacity_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_BatterySystem_batt_replacement_schedule_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_battery_replacement_cost_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_battery_replacement_cost_schedule_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_disbursement_equip1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_disbursement_equip2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_disbursement_equip3_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_disbursement_leasepayment_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_disbursement_merr_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_disbursement_om_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_disbursement_receivables_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_effective_tax_frac_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_apr_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_aug_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dec_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch3_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch4_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch5_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch6_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch7_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch8_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_dispatch9_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_feb_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_jan_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_jul_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_jun_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_mar_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_may_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD1_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD2_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD3_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD4_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD5_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD6_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD7_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD8_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_monthly_firstyear_TOD9_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_nov_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_oct_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_energy_net_sep_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_feddepr_custom_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_feddepr_macrs_15_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_feddepr_macrs_5_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_federal_tax_frac_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_funding_equip1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_funding_equip2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_funding_equip3_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_funding_leasepayment_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_funding_receivables_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_insurance_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_net_salvage_value_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_om_capacity_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_om_fixed_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_om_fuel_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_om_opt_fuel_1_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_om_opt_fuel_2_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_om_production_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_operating_expenses_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_pbi_fedtax_total_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_pbi_statax_total_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_pretax_cashflow_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_pretax_operating_cashflow_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_property_tax_assessed_value_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_property_tax_expense_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_recapitalization_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_reserve_equip1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_reserve_equip2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_reserve_equip3_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_reserve_interest_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_reserve_leasepayment_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_reserve_leasepayment_interest_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_reserve_receivables_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch3_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch4_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch5_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch6_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch7_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch8_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_dispatch9_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD1_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD2_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD3_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD4_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD5_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD6_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD7_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD8_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_revenue_monthly_firstyear_TOD9_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_adj_reserve_release_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_aftertax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_aftertax_cash_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_aftertax_devfee_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_aftertax_irr_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_aftertax_npv_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_aftertax_tax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_fedtax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_fedtax_income_prior_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_fedtax_income_with_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                        SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_fedtax_taxable_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_financing_activities_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_investing_activities_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_margin_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_operating_activities_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_operating_margin_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_pretax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_pretax_irr_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_pretax_npv_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_receivablesra_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_statax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_statax_income_prior_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_statax_income_with_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                        SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_sponsor_statax_taxable_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_stadepr_custom_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_stadepr_macrs_15_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_stadepr_macrs_5_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_state_tax_frac_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_cash_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_irr_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_itc_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_max_irr_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_npv_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_ptc_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_aftertax_tax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_fedtax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_fedtax_income_prior_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                              SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_fedtax_income_with_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                             SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_fedtax_taxable_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_financing_activities_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_investing_activities_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_operating_activities_aget(SAM_Saleleaseback ptr, int *length,
                                                                    SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_pretax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_pretax_cashflow_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_pretax_irr_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_pretax_npv_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_statax_aget(SAM_Saleleaseback ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_statax_income_prior_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                              SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_statax_income_with_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                             SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Saleleaseback_Outputs_cf_tax_investor_statax_taxable_incentives_aget(SAM_Saleleaseback ptr, int *length,
                                                                         SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_first_year_bonus_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_fixed_amount_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_fixed_amount_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_fixed_amount_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_fed_reduction_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_itc_sta_reduction_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_amount_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_qual_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_qual_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_fedbas_percent_qual_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_first_year_bonus_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_fixed_amount_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_fixed_amount_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_fixed_amount_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_fed_reduction_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_itc_sta_reduction_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_sl_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_sl_20_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_sl_39_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_sl_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_amount_total_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_qual_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_qual_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_depr_stabas_percent_qual_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_distribution_of_development_fee_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_fed_fixed_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_fed_percent_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_fed_percent_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_fed_percent_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_sta_fixed_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_sta_percent_custom_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_sta_percent_macrs_15_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
...
SAM_EXPORT double
SAM_Saleleaseback_Outputs_itc_disallow_sta_percent_macrs_5_nget(SAM_Saleleaseback ptr, SAM_error *err) {
    double result;
    translateExceptions(err, [&] {
