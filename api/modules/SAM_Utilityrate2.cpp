...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_annual_energy_value_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_apr_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_aug_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_dec_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_feb_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_jan_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_jul_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_jun_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_mar_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_may_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_nov_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_oct_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_charge_dc_fixed_sep_aget(SAM_Utilityrate2 ptr, int *length, SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
...
SAM_EXPORT double *
SAM_Utilityrate2_Outputs_year1_monthly_ec_charge_without_system_aget(SAM_Utilityrate2 ptr, int *length,
                                                                     SAM_error *err) {
    double *result = nullptr;
    translateExceptions(err, [&] {
