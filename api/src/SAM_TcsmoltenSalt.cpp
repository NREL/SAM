...
SAM_EXPORT SAM_TcsmoltenSalt SAM_TcsmoltenSalt_construct(const char* def, SAM_error* err){
	SAM_TcsmoltenSalt result = nullptr;
...
SAM_EXPORT void SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_sched_weekend_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "dispatch_sched_weekend", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_TimeOfDeliveryFactors_ppa_multiplier_model_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_check_max_flux_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_focus_type_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_helio_active_fraction_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "helio_active_fraction", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_helio_aim_points_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "helio_aim_points", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_helio_height_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_helio_reflectance_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "helio_reflectance", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_helio_width_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_land_bound_list_aset(SAM_TcsmoltenSalt ptr, float* arr, int length, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_array(ptr, "land_bound_list", arr, length);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_land_bound_table_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "land_bound_table", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_land_max_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_opt_max_iter_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "opt_max_iter", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_p_start_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "p_start", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_p_track_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "p_track", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_v_wind_max_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "v_wind_max", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_washing_frequency_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "washing_frequency", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_HeliostatField_water_usage_per_wash_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "water_usage_per_wash", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemDesign_P_ref_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "P_ref", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemDesign_T_htf_cold_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_htf_cold_des", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemDesign_T_htf_hot_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_htf_hot_des", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemDesign_design_eff_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemDesign_sf_excess_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "sf_excess", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemDesign_solarm_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "solarm", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemDesign_tshours_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_csp_pt_rec_max_oper_frac_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_f_rec_min_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_flux_max_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_n_flux_days_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_piping_length_mult_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_rec_absorptance_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "rec_absorptance", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_rec_height_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_rec_qf_delay_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "rec_qf_delay", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_rec_su_delay_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "rec_su_delay", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_TowerAndReceiver_th_tube_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "th_tube", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_bop_spec_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "bop_spec_cost", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_contingency_rate_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "contingency_rate", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_cost_sf_fixed_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "cost_sf_fixed", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_fixed_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.cost.epc.fixed", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_per_acre_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.cost.epc.per_acre", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_per_watt_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.cost.epc.per_watt", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_percent_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.cost.epc.percent", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_plm_fixed_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.cost.plm.fixed", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_plm_per_watt_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.cost.plm.per_watt", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_plm_percent_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.cost.plm.percent", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_fossil_spec_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "fossil_spec_cost", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_heliostat_spec_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "heliostat_spec_cost", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_land_spec_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_rec_ref_area_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "rec_ref_area", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_rec_ref_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "rec_ref_cost", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_sales_tax_frac_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "sales_tax_frac", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_site_spec_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_tower_exp_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "tower_exp", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemCosts_tower_fixed_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "tower_fixed_cost", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate1_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_interest_rate1", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate2_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_interest_rate2", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate3_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_interest_rate3", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate4_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_months5_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_months5", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_percent1_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_percent1", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_percent2_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_percent2", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_percent3_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_percent3", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_percent4_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_percent4", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_percent5_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_percent5", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate1_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_upfront_rate1", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate2_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_upfront_rate2", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate3_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_upfront_rate3", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate4_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_upfront_rate4", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate5_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "const_per_upfront_rate5", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_FinancialParameters_sales_tax_rate_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "sales_tax_rate", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_cold_tank_Thtr_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "cold_tank_Thtr", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_cold_tank_max_heat_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "cold_tank_max_heat", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_csp_pt_tes_init_hot_htf_percent_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "csp.pt.tes.init_hot_htf_percent", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_h_tank_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "h_tank", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_h_tank_min_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "h_tank_min", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_hot_tank_Thtr_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_tank_pairs_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "tank_pairs", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_ThermalStorage_u_tank_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_PowerCycle_cycle_max_frac_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_PowerCycle_q_sby_frac_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "q_sby_frac", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_PowerCycle_startup_frac_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "startup_frac", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_PowerCycle_startup_time_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "startup_time", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_CT_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "CT", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_P_boil_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_P_cond_ratio_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "P_cond_ratio", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_T_ITD_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_ITD_des", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_T_amb_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_amb_des", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_T_approach_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "T_approach", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_dT_cw_ref_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_RankineCycle_tech_type_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_aux_par_f_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_bop_par_f_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "bop_par_f", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_disp_csu_cost_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "disp_csu_cost", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_disp_frequency_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_disp_mip_gap_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_disp_reporting_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_disp_time_weighting_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_is_write_ampl_dat_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "is_write_ampl_dat", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_pb_fixed_par_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "pb_fixed_par", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_q_rec_heattrace_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "q_rec_heattrace", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_q_rec_standby_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_time_steps_per_hour_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_weekend_schedule_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "weekend_schedule", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_wlim_series_aset(SAM_TcsmoltenSalt ptr, float* arr, int length, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_array(ptr, "wlim_series", arr, length);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_amb_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_amb_ind_od_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "ud_T_amb_ind_od", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_amb_low_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_htf_ind_od_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "ud_T_htf_ind_od", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_htf_low_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_m_dot_htf_low_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "ud_m_dot_htf_low", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_m_dot_water_cool_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "ud_m_dot_water_cool_des", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_P_high_limit_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "P_high_limit", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle__sco2_P_high_limit_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "_sco2_P_high_limit", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle__sco2_P_ref_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "_sco2_P_ref", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle__sco2_T_amb_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "_sco2_T_amb_des", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle__sco2_T_approach_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "_sco2_T_approach", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle__sco2_T_htf_hot_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle__sco2_recup_eff_max_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_eta_t_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_recup_eff_max_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "recup_eff_max", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_sco2_T_amb_des_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_sco2_cycle_config_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_amb_ind_od_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_matrix(ptr, "sco2ud_T_amb_ind_od", mat, nrows, ncols);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_amb_low_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "sco2ud_T_amb_low", number);
	});
}

SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_htf_cold_calc_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_htf_ind_od_mset(SAM_TcsmoltenSalt ptr, float* mat, int nrows, int ncols, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_m_dot_htf_low_fset(SAM_TcsmoltenSalt ptr, float number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor6_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor7_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor8_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factor9_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_factors_ts_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
...
SAM_EXPORT float* SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_sched_weekday_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_TimeOfDeliveryFactors_dispatch_sched_weekend_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TimeOfDeliveryFactors_ppa_multiplier_model_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_A_sf_in_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_N_hel_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_c_atm_0_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_c_atm_1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_c_atm_2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_c_atm_3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_calc_fluxmaps_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_cant_type_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_check_max_flux_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_csp_pt_sf_fixed_land_area_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_csp_pt_sf_land_overhead_factor_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_dens_mirror_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_HeliostatField_eta_map_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_eta_map_aod_format_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_field_model_type_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_HeliostatField_flux_maps_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_focus_type_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_hel_stow_deploy_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_helio_active_fraction_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_HeliostatField_helio_aim_points_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_helio_height_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_helio_optical_error_mrad_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_HeliostatField_helio_positions_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_helio_reflectance_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_helio_width_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_land_area_base_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_HeliostatField_land_bound_list_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_HeliostatField_land_bound_table_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_land_max_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_land_min_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_n_facet_x_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_n_facet_y_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_opt_algorithm_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_opt_conv_tol_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_opt_flux_penalty_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_opt_init_step_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_opt_max_iter_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_p_start_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_p_track_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_v_wind_max_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_washing_frequency_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_HeliostatField_water_usage_per_wash_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_P_ref_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_T_htf_cold_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_T_htf_hot_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_design_eff_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_dni_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_gross_net_conversion_factor_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_sf_excess_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_solarm_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemDesign_tshours_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_D_rec_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_Flow_type_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_N_panels_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_crossover_shift_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_csp_pt_rec_max_oper_frac_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_d_tube_out_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_delta_flux_hrs_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_epsilon_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_eta_pump_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_f_rec_min_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_TowerAndReceiver_field_fl_props_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_flux_max_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_h_tower_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_hl_ffact_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_mat_tube_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_n_flux_days_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_piping_length_const_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_piping_length_mult_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_piping_loss_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_rec_absorptance_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_rec_height_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_rec_hl_perm2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_rec_htf_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_rec_qf_delay_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_rec_su_delay_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_TowerAndReceiver_th_tube_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_bop_spec_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_contingency_rate_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_cost_sf_fixed_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_fixed_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_per_acre_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_per_watt_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_epc_percent_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_plm_fixed_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_plm_per_watt_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_csp_pt_cost_plm_percent_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_fossil_spec_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_heliostat_spec_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_land_spec_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_plant_spec_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_rec_cost_exp_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_rec_ref_area_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_rec_ref_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_sales_tax_frac_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_site_spec_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_tes_spec_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_tower_exp_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemCosts_tower_fixed_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_interest_rate5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_months1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_months2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_months3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_months4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_months5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_percent1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_percent2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_percent3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_percent4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_percent5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_const_per_upfront_rate5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_FinancialParameters_sales_tax_rate_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_cold_tank_Thtr_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_cold_tank_max_heat_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_csp_pt_tes_init_hot_htf_percent_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_h_tank_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_h_tank_min_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_hot_tank_Thtr_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_hot_tank_max_heat_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_tank_pairs_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_ThermalStorage_u_tank_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_PowerCycle_cycle_cutoff_frac_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_PowerCycle_cycle_max_frac_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_PowerCycle_pb_pump_coef_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_PowerCycle_pc_config_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_PowerCycle_q_sby_frac_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_PowerCycle_startup_frac_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_PowerCycle_startup_time_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_CT_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_P_boil_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_P_cond_min_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_P_cond_ratio_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_T_ITD_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_T_amb_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_T_approach_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_dT_cw_ref_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_n_pl_inc_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_pb_bd_frac_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_RankineCycle_tech_type_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SystemControl_F_wc_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_aux_par_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_aux_par_0_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_aux_par_1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_aux_par_2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_aux_par_f_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_bop_par_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_bop_par_0_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_bop_par_1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_bop_par_2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_bop_par_f_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_csu_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_frequency_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_horizon_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_max_iter_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_mip_gap_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_pen_delta_w_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_reporting_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_rsu_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_spec_bb_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_spec_presolve_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_spec_scaling_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_steps_per_hour_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_time_weighting_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_disp_timeout_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SystemControl_dispatch_series_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SystemControl_f_turb_tou_periods_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_is_ampl_engine_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_is_dispatch_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_is_dispatch_series_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_is_wlim_series_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_is_write_ampl_dat_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_pb_fixed_par_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_q_rec_heattrace_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_q_rec_standby_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_time_start_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_time_steps_per_hour_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_time_stop_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SystemControl_vacuum_arrays_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SystemControl_weekday_schedule_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SystemControl_weekend_schedule_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SystemControl_wlim_series_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_amb_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ud_T_amb_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "ud_T_amb_des");
	});
	return result;
}
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_amb_high_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ud_T_amb_high", &result))
		make_access_error("SAM_TcsmoltenSalt", "ud_T_amb_high");
	});
	return result;
}
...
SAM_EXPORT float* SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_amb_ind_od_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_matrix(ptr, "ud_T_amb_ind_od", nrows, ncols);
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "ud_T_amb_ind_od");
	});
	return result;
}
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_amb_low_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ud_T_amb_low", &result))
		make_access_error("SAM_TcsmoltenSalt", "ud_T_amb_low");
	});
	return result;
}
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_htf_high_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ud_T_htf_high", &result))
		make_access_error("SAM_TcsmoltenSalt", "ud_T_htf_high");
	});
	return result;
}
...
SAM_EXPORT float* SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_htf_ind_od_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_matrix(ptr, "ud_T_htf_ind_od", nrows, ncols);
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "ud_T_htf_ind_od");
	});
	return result;
}
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_T_htf_low_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ud_T_htf_low", &result))
		make_access_error("SAM_TcsmoltenSalt", "ud_T_htf_low");
	});
	return result;
}
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_f_W_dot_cool_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_ind_od_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_m_dot_htf_high_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ud_m_dot_htf_high", &result))
		make_access_error("SAM_TcsmoltenSalt", "ud_m_dot_htf_high");
	});
	return result;
}
...
SAM_EXPORT float* SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_m_dot_htf_ind_od_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_matrix(ptr, "ud_m_dot_htf_ind_od", nrows, ncols);
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "ud_m_dot_htf_ind_od");
	});
	return result;
}
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_m_dot_htf_low_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ud_m_dot_htf_low", &result))
		make_access_error("SAM_TcsmoltenSalt", "ud_m_dot_htf_low");
	});
	return result;
}
...
SAM_EXPORT float SAM_TcsmoltenSalt_UserDefinedPowerCycle_ud_m_dot_water_cool_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_P_high_limit_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_P_high_limit_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_P_ref_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_T_amb_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_T_approach_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_T_htf_hot_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_deltaT_PHX_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_design_eff_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_eta_c_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_eta_t_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle__sco2_recup_eff_max_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_deltaT_PHX_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_eta_c_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_eta_t_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_fan_power_perc_net_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_is_sco2_preprocess_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_recup_eff_max_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2_T_amb_des_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2_T_approach_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2_cycle_config_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_amb_high_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_amb_ind_od_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_amb_low_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_htf_cold_calc_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_htf_high_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_htf_ind_od_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_T_htf_low_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_m_dot_htf_high_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_m_dot_htf_ind_od_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_SCO2Cycle_sco2ud_m_dot_htf_low_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_A_sf_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_P_cooling_tower_tot_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_P_cycle_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_P_fixed_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_P_out_net_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_P_plant_balance_tot_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_P_tower_pump_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_Q_thermal_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_T_pc_in_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_T_pc_out_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_T_rec_in_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_T_rec_out_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_T_tes_cold_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_T_tes_hot_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_annual_W_cycle_gross_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_annual_energy_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_annual_total_water_use_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_beam_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_capacity_factor_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_interest1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_interest2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_interest3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_interest4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_interest5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_interest_total_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_percent_total_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_principal1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_principal2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_principal3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_principal4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_principal5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_principal_total_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_total1_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_total2_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_total3_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_total4_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_const_per_total5_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_construction_financing_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_conversion_factor_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_bop_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_contingency_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_epc_total_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_fossil_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_heliostats_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_installed_per_capacity_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_plm_total_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_power_block_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_receiver_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_sales_tax_total_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_site_improvements_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_storage_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_total_land_area_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_csp_pt_cost_tower_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_defocus_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_disp_iter_ann_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_obj_relax_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_objective_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_disp_objective_ann_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_pceff_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_presolve_nconstr_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_disp_presolve_nconstr_ann_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_presolve_nvar_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_disp_presolve_nvar_ann_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_qpbsu_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_qsf_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_qsfprod_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_qsfsu_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_rev_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_solve_iter_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_solve_state_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_solve_time_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_disp_solve_time_ann_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_tes_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_thermeff_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_disp_wpb_expected_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_e_ch_tes_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_eta_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_eta_field_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_eta_map_out_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_eta_therm_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_flux_maps_out_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_gen_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_htf_pump_power_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_is_pc_sb_allowed_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_is_pc_su_allowed_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_is_rec_su_allowed_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_kwh_per_kw_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_m_dot_balance_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_m_dot_pc_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_m_dot_rec_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_m_dot_tes_ch_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "m_dot_tes_ch", length);
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "m_dot_tes_ch");
	});
	return result;
}
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_m_dot_tes_dc_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "m_dot_tes_dc", length);
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "m_dot_tes_dc");
	});
	return result;
}
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_m_dot_water_pc_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_n_op_modes_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_op_mode_1_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_op_mode_2_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_op_mode_3_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_operating_modes_a_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_operating_modes_b_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_operating_modes_c_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_pparasi_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_pricing_mult_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_balance_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_ch_tes_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dc_tes_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_est_cr_on_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_est_cr_su_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_est_tes_ch_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_est_tes_dc_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_pc_max_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_pc_min_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_pc_sb_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_pc_startup_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_pc_target_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_dot_rec_inc_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_heater_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_pb_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_pc_startup_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_piping_losses_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_sf_inc_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_startup_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_q_thermal_loss_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_rh_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_sf_adjust_out_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_solaz_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_solzen_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_tank_losses_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_tdry_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_time_hr_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_total_direct_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_total_indirect_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_total_installed_cost_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_tou_value_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_twet_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_ud_T_amb_ind_od_out_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_ud_T_htf_ind_od_out_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_ud_m_dot_htf_ind_od_out_mget(SAM_TcsmoltenSalt ptr, int* nrows, int* ncols, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
...
SAM_EXPORT float SAM_TcsmoltenSalt_Outputs_ui_direct_subtotal_fget(SAM_TcsmoltenSalt ptr, SAM_error *err){
	float result;
	translateExceptions(err, [&]{
...
SAM_EXPORT float* SAM_TcsmoltenSalt_Outputs_wspd_aget(SAM_TcsmoltenSalt ptr, int* length, SAM_error *err){
	float* result = nullptr;
	translateExceptions(err, [&]{
