...
SAM_EXPORT void SAM_AdjustmentFactors_adjust_constant_fset(void* ptr, float number, SAM_error *err){
...
SAM_EXPORT void SAM_AdjustmentFactors_dc_adjust_constant_fset(void* ptr, float number, SAM_error *err){
    translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_AdjustmentFactors_sf_adjust_constant_fset(void* ptr, float number, SAM_error *err){
    translateExceptions(err, [&]{
