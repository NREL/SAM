 ...
 */
SAM_EXPORT void
SAM_Pvwattsv5_Lifetime_system_use_lifetime_output_nset(SAM_Pvwattsv5 ptr, double number, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_Pvwattsv5_SolarResource_solar_resource_file_sset(SAM_Pvwattsv5 ptr, const char *str, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_Pvwattsv5_SystemDesign_shading_azal_mset(SAM_Pvwattsv5 ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_Pvwattsv5_SystemDesign_shading_mxh_mset(SAM_Pvwattsv5 ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_Pvwattsv5_SystemDesign_shading_timestep_mset(SAM_Pvwattsv5 ptr, double *mat, int nrows, int ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_Pvwattsv5_SystemDesign_shading_azal_mget(SAM_Pvwattsv5 ptr, int *nrows, int *ncols, SAM_error *err);

SAM_EXPORT double SAM_Pvwattsv5_SystemDesign_shading_diff_nget(SAM_Pvwattsv5 ptr, SAM_error *err);

SAM_EXPORT double *
SAM_Pvwattsv5_SystemDesign_shading_mxh_mget(SAM_Pvwattsv5 ptr, int *nrows, int *ncols, SAM_error *err);

SAM_EXPORT double *
SAM_Pvwattsv5_SystemDesign_shading_timestep_mget(SAM_Pvwattsv5 ptr, int *nrows, int *ncols, SAM_error *err);
