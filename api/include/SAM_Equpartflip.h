...
extern "C"
{
	 ...
	 * required if: None
	 */
	SAM_EXPORT void SAM_Equpartflip_BatterySystem_batt_replacement_schedule_aset(SAM_table ptr, double* arr, int length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Equpartflip_BatterySystem_batt_replacement_schedule_aget(SAM_table ptr, int* length, SAM_error *err);
