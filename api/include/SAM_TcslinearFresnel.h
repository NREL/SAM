 ...
 */
SAM_EXPORT void
SAM_TcslinearFresnel_Solarfield_HL_dT_mset(SAM_TcslinearFresnel ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcslinearFresnel_Solarfield_IAM_L_mset(SAM_TcslinearFresnel ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcslinearFresnel_Solarfield_IAM_T_mset(SAM_TcslinearFresnel ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcslinearFresnel_Solarfield_L_col_mset(SAM_TcslinearFresnel ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcslinearFresnel_Solarfield_Rough_mset(SAM_TcslinearFresnel ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcslinearFresnel_Solarfield_error_mset(SAM_TcslinearFresnel ptr, double *mat, int nrows, int ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_TcslinearFresnel_Solarfield_AbsorberMaterial_mget(SAM_TcslinearFresnel ptr, int *nrows, int *ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_TcslinearFresnel_Solarfield_rho_mirror_clean_mget(SAM_TcslinearFresnel ptr, int *nrows, int *ncols, SAM_error *err);
