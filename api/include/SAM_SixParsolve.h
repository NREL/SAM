#ifndef SAM_SIXPARSOLVE_H_
#define SAM_SIXPARSOLVE_H_
...
extern "C"
{
	...
	//
	// SixParsolve Technology Model
	//

	/** 
	 * Create a SixParsolve variable table.
	 * @param def: the set of financial model-dependent defaults to use (None, Residential, ...)
	 * @param[in,out] err: a pointer to an error object
	 */

	SAM_EXPORT typedef void * SAM_SixParsolve;
