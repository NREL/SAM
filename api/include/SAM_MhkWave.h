 ...
 */
SAM_EXPORT void
SAM_MhkWave_MHKWave_wave_power_matrix_mset(SAM_MhkWave ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_MhkWave_MHKWave_wave_resource_matrix_mset(SAM_MhkWave ptr, double *mat, int nrows, int ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_MhkWave_MHKWave_wave_resource_matrix_mget(SAM_MhkWave ptr, int *nrows, int *ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_MhkWave_Outputs_annual_energy_distribution_mget(SAM_MhkWave ptr, int *nrows, int *ncols, SAM_error *err);
