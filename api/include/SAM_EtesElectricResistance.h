...
extern "C"
{
	...
	/**
	 * Set tes_fl_code: Receiver HTF, 17=Salt (60% NaNO3, 40% KNO3) 10=Salt (46.5% LiF 11.5% NaF 42% KF) 50=Lookup tables
	 * options: None
	 * constraints: None
	 * required if: *
	 */
	...
	/**
	 * Set ud_tes_fl_props: User-defined TES fluid property data [-]
	 * options: None
	 * constraints: None
	 * required if: *
	 */
