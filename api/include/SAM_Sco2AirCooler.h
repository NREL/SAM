...
extern "C"
{
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Sco2AirCooler_Common_P_co2_hot_in_nset(SAM_table ptr, double number, SAM_error *err);
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Sco2AirCooler_Common_T_amb_nset(SAM_table ptr, double number, SAM_error *err);
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Sco2AirCooler_Common_T_co2_cold_out_nset(SAM_table ptr, double number, SAM_error *err);
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Sco2AirCooler_Common_T_co2_hot_in_nset(SAM_table ptr, double number, SAM_error *err);
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Sco2AirCooler_Common_W_dot_fan_nset(SAM_table ptr, double number, SAM_error *err);
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Sco2AirCooler_Common_deltaP_nset(SAM_table ptr, double number, SAM_error *err);
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Sco2AirCooler_Common_q_dot_reject_nset(SAM_table ptr, double number, SAM_error *err);
	...
	SAM_EXPORT double SAM_Sco2AirCooler_Common_P_co2_hot_in_nget(SAM_table ptr, SAM_error *err);

	SAM_EXPORT double SAM_Sco2AirCooler_Common_T_amb_nget(SAM_table ptr, SAM_error *err);

	SAM_EXPORT double SAM_Sco2AirCooler_Common_T_co2_cold_out_nget(SAM_table ptr, SAM_error *err);

	SAM_EXPORT double SAM_Sco2AirCooler_Common_T_co2_hot_in_nget(SAM_table ptr, SAM_error *err);

	SAM_EXPORT double SAM_Sco2AirCooler_Common_W_dot_fan_nget(SAM_table ptr, SAM_error *err);

	SAM_EXPORT double SAM_Sco2AirCooler_Common_deltaP_nget(SAM_table ptr, SAM_error *err);

	SAM_EXPORT double SAM_Sco2AirCooler_Common_q_dot_reject_nget(SAM_table ptr, SAM_error *err);
