 ...
 */
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_D_2_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_D_3_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_D_4_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_D_5_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_D_p_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_P_a_mset(SAM_TcstroughPhysical ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_TcstroughPhysical_SolarField_TrackingError_aset(SAM_TcstroughPhysical ptr, double *arr, int length, SAM_error *err);
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_field_fl_props_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_TcstroughPhysical_Controller_store_fl_props_mget(SAM_TcstroughPhysical ptr, int *nrows, int *ncols, SAM_error *err);
