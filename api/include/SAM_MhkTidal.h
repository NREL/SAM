 ...
 */
SAM_EXPORT void
SAM_MhkTidal_MHKTidal_loss_resource_overprediction_nset(SAM_MhkTidal ptr, double number, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_MhkTidal_MHKTidal_tidal_power_curve_mset(SAM_MhkTidal ptr, double *mat, int nrows, int ncols, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_MhkTidal_MHKTidal_tidal_resource_mset(SAM_MhkTidal ptr, double *mat, int nrows, int ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_MhkTidal_MHKTidal_tidal_power_curve_mget(SAM_MhkTidal ptr, int *nrows, int *ncols, SAM_error *err);
...
SAM_EXPORT double *
SAM_MhkTidal_Outputs_annual_cumulative_energy_distribution_aget(SAM_MhkTidal ptr, int *length, SAM_error *err);
