 ...
 */
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_HTR_eff_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_LTR_eff_des_in_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_Sco2CspUdPcTables_HeatExchangerDesign_min_phx_deltaT_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err);
 ...
 */
SAM_EXPORT void
SAM_Sco2CspUdPcTables_AirCoolerDesign_deltaP_cooler_frac_nset(SAM_Sco2CspUdPcTables ptr, double number, SAM_error *err);
