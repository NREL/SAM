...
abs_path_to_props = r"C:\Users\WHamilt2\Documents\Projects\Powdermet\salt_properties\45_98MgCl2_38_91KCl_15_11NaCl\salt_props.csv"
with open(abs_path_to_props, 'r') as read_obj:
    csv_reader = csv.reader(read_obj, quoting=csv.QUOTE_NONNUMERIC)
    htf_props = list(csv_reader)

sco2_des_par_default["htf"] = 50
sco2_des_par_default["htf_props"] = htf_props
sco2_des_par_default["T_htf_hot_des"] = 700.0
sco2_des_par_default["cycle_config"] = 1
sco2_des_par_default["PHX_n_sub_hx"] = 20
...
abs_path_to_props = r"C:\Users\WHamilt2\Documents\Projects\Powdermet\salt_properties\45_98MgCl2_38_91KCl_15_11NaCl\modified_salt_props.csv"
with open(abs_path_to_props, 'r') as read_obj:
    csv_reader = csv.reader(read_obj, quoting=csv.QUOTE_NONNUMERIC)
    htf_props = list(csv_reader)

mod_base_dict = {"htf" : 50} 
mod_base_dict["htf_props"] = htf_props
mod_base_dict["T_htf_hot_des"] = 700.0
mod_base_dict["dT_PHX_hot_approach"] = 80.0  #65.0 (config 2)
mod_base_dict["cycle_config"] = 1
mod_base_dict["PHX_n_sub_hx"] = 50
...
# Modify solve dictionary for PCM plotting
sol_dict__mod_pars['PCM_temp_range'] = [562.5, 582.5]  # [C]
sol_dict__mod_pars['sco2_PHX_avg_Cp'] = 1.253952381     # [kJ/kg-K]
