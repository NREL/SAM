...
// @returns single value or var_table
//
var_table Pvsamv1_InverterCECDatabase_inv_snl_eff_cec_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float Pvsamv1_CECPerformanceModelWithModuleDatabase_cec_p_mp_ref_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float Pvsamv1_InverterPartLoadCurve_inv_pd_pdco_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float Pvsamv1_CECPerformanceModelWithUserEnteredSpecifications_6par_pmp_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float Pvsamv1_PVSystemDesign_total_modules_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table Pvsamv1_PVSystemDesign_subarray2_enable_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float Pvsamv1_SimpleEfficiencyModuleModel_spe_power_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table Pvsamv1_InverterCECCoefficientGenerator_inv_cec_cg_eff_cec_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table Pvsamv1_SandiaPVArrayPerformanceModelWithModuleDatabase_snl_ref_a_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
