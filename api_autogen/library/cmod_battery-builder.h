...
//
var_table Battery_BatteryCurrentAndCapacity_batt_computed_voltage_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float Battery_BatteryThermal_batt_width_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table Battery_BatteryCurrentAndCapacity_LeadAcid_q10_computed_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table Battery_BatteryCurrentAndCapacity_batt_Qexp_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
util::matrix_t<ssc_number_t> Battery_BatteryDispatchManual_dispatch_manual_percent_gridcharge_eval(var_table* vt, invoke_t* cxt = 0)
