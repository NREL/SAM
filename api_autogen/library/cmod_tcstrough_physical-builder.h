...
//
float TcstroughPhysical_PhysicalTroughPowerBlockCommon_system_capacity_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float TcstroughPhysical_PhysicalTroughSolarField_total_loop_conversion_efficiency_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table TcstroughPhysical_PhysicalTroughCollectorHeader_W_aperture_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table TcstroughPhysical_PhysicalTroughPowerBlockCommon_W_pb_design_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
var_table TcstroughPhysical_PhysicalTroughCollectorHeader_collectors_in_field_MIMO_eval(var_table* vt, invoke_t* cxt = 0)
...
// @returns single value or var_table
//
float TcstroughPhysical_PhysicalTroughThermalStorage_csp.dtr.tes.hx_derate_eval(var_table* vt, invoke_t* cxt = 0)
