...
\bibitem[Dobos(2014)]{dobos2014} Dobos, A.; MacAlpine, S.; (2014). ``Procedure for Applying IEC-61853 Test Data to a Single Diode Mode.'' Proc. IEEE 40$^{\mbox{th}}$ PVSC Conf., Denver, CO, June, 2014.
...
\bibitem[Hansen(2013)]{hansen2013} Hansen, C.W; \emph{Estimation of Parameters for Single Diode Models Using Measured IV Curves}. Proc. IEEE PVSC 39, Tampa Bay, FL, 2013.
...
\bibitem[MacAlpine(2015)]{macalpine2015} MacAlpine, S.; Deline, C.; ``Simplified Method for Modeling the Impact of Arbitrary Partial Shading Conditions on PV Array Performance''.  Proc. IEEE 41st PVSC Conf, New Orleans, LA, June, 2015.
