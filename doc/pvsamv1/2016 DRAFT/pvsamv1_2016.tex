...
This manual describes the photovoltaic performance model in the System Advisor Model (SAM) Version 2016.3.14 Revision 4 (SSC Version 160). It is an update to \citet{gilman2015}, which describes the photovoltaic model in SAM Version 2014.1.14. The U.S. Department of Energy's National Renewable Energy Laboratory maintains and distributes SAM, which is available as a free download from \url{https://sam.nrel.gov}. These descriptions are based on SAM 2015.1.30 (SSC 41).
...
\item Battery storage model (Section~\ref{battery})
...
\item Support for subhourly simulations (Section~\ref{sec-irradianceweatherdata})
...
In SSC (accesible using the SAM Software Development Kit), the battery model is part of the \texttt{pvsamv1} module. To enable the battery model in SSC, set $\texttt{en\_batt}=1$. See the tables on the following pages for lists of the battery input and output variables in SSC.
...
2014.1.14: General Description." NREL/TP-6A20-61019. Golden, CO: National Renewable Energy Laboratory. Accessed November 1, 2016: \url{http://www.nrel.gov/docs/fy14osti/61019.pdf}
...
\bibitem[SAM Download(2016)]{download} ``Download SAM." \url{https://sam.nrel.gov/download} (Accessed November 1, 2016)
...
\bibitem[SAM Release Notes(2016)]{releasenotes} ``System Advisor Model (SAM) Release Notes." (2016). National Renewable Energy Laboratory. Accessed November 1, 2016: \url{https://sam.nrel.gov/sites/default/files/content/updates/releasenotes.html}
