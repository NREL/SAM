...
$P_{dc,gross,n}$ & \textbf{Subarray [\textit{n}] Gross DC output}(W) &  \texttt{subarray[\textit{n}]\_dc\_gross} \\
$P_{dc,net,n}$ & \textbf{Subarray [\textit{n}] Net DC output} (W)&  \texttt{subarray[\textit{n}]\_dc\_net} \\
$P_{dc,gross}$ & \textbf{Gross dc array output} (W)& \texttt{dc\_gross} \\
$P_{dc,net}$ & \textbf{Net dc array output} (W)& \texttt{dc\_net} \\
\hline
\end{tabular}
