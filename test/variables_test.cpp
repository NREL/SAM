...
vv.
AsSSCVar(data_returned);
EXPECT_EQ(ssc_var_query(data_returned),
SSC_INVALID);
...
auto var_returned = ssc_var_create();
vv.
AsSSCVar(var_returned);
EXPECT_EQ(ssc_var_query(var_returned),
SSC_NUMBER);
EXPECT_EQ(ssc_var_get_number(var_returned),
10);
...
EXPECT_EQ(ssc_var_query(var_returned),
SSC_ARRAY);
EXPECT_EQ(ssc_var_get_array(var_returned, nullptr)
[0], 2);
EXPECT_EQ(ssc_var_get_array(var_returned, nullptr)
[1], 3);
...
EXPECT_EQ(ssc_var_query(var_returned),
SSC_MATRIX);
EXPECT_EQ(ssc_var_get_matrix(var_returned, nullptr, nullptr)
[0], 2);
EXPECT_EQ(ssc_var_get_matrix(var_returned, nullptr, nullptr)
[1], 3);
EXPECT_EQ(ssc_var_get_matrix(var_returned, nullptr, nullptr)
...
ssc_var_set_number(vd[i],
2 + i);
}

// set using ssc_data
auto data = ssc_data_create();
ssc_data_set_data_array(data,
"array", &vd[0], 2);
...
vv->
AsSSCVar(data_arr);
EXPECT_EQ(ssc_var_get_number(ssc_var_get_var_array(data_arr, 0)),
2);
EXPECT_EQ(ssc_var_get_number(ssc_var_get_var_array(data_arr, 1)),
3);
...
EXPECT_EQ(ssc_var_get_number(ssc_var_get_var_matrix(data_matt, 0, 0)),
2);
EXPECT_EQ(ssc_var_get_number(ssc_var_get_var_matrix(data_matt, 0, 1)),
3);
EXPECT_EQ(ssc_var_get_number(ssc_var_get_var_matrix(data_matt, 1, 0)),
4);
EXPECT_EQ(ssc_var_get_number(ssc_var_get_var_matrix(data_matt, 1, 1)),
5);
...
(unsigned char)lk::vardata_t::NULLVAL);
...
EXPECT_EQ(ssc_var_query(var),
SSC_NUMBER);
EXPECT_EQ(ssc_var_get_number(var),
10);
...
(unsigned char)lk::vardata_t::NUMBER);
EXPECT_EQ(vd
.
...
EXPECT_EQ(vd_returned
.

type(),

(unsigned char)lk::vardata_t::STRING);
EXPECT_EQ(vd_returned
.
...
(unsigned char)lk::vardata_t::VECTOR);
EXPECT_EQ((*vd
.
...
(unsigned char)lk::vardata_t::HASH);
EXPECT_EQ(vd
.lookup("string")->
...
ssc_var_set_string(entry[i], std::to_string(i + 2)
.
