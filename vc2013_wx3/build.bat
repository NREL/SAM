...
msbuild %WEXDIR%\wex\trunk\vc2013_wx3\wexvc13wx3.sln /p:Configuration=Release;Platform=win32
msbuild %WEXDIR%\wex\trunk\vc2013_wx3\wexvc13wx3.sln /p:Configuration=Debug;Platform=x64
msbuild %WEXDIR%\wex\trunk\vc2013_wx3\wexvc13wx3.sln /p:Configuration=Release;Platform=x64

msbuild %SSCDIR%\build_vc2013\ssc_vc2013.sln /p:Configuration=Debug;Platform=win32
msbuild %SSCDIR%\ssc_vc2013.sln /p:Configuration=Release;Platform=win32
msbuild %SSCDIR%\build_vc2013\ssc_vc2013.sln /p:Configuration=Debug;Platform=x64
msbuild %SSCDIR%\ssc\build_vc2013\ssc_vc2013.sln /p:Configuration=Release;Platform=x64
...
msbuild %SAMNTDIR%\SAMnt\vc2013_wx3\SAMnt_vc2013.sln /p:Configuration=Release;Platform=win32
msbuild %SAMNTDIR%\SAMnt\vc2013_wx3\SAMnt_vc2013.sln /p:Configuration=Debug;Platform=x64
msbuild %SAMNTDIR%\SAMnt\vc2013_wx3\SAMnt_vc2013.sln /p:Configuration=Release;Platform=x64
